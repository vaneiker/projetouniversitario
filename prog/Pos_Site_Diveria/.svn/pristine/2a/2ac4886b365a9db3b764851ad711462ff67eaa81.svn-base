    ...
    public partial class InclusionController : BaseController
    {
        ...
        public JsonResult SaveVehicleExclusion(string jsondataVehicle, string StartDate, string EndDate, string AgentCode, string DataCustomer, string policyNoMain, string QuotationId)
        {
            ...
            try
            {
                ...
                if (IsAllDeclarativaProduct(base.QuotationId))
                {
                    qparam.RequestTypeId = CommonEnums.RequestType.ExclusionDeclarativa.ToInt();
                    base.RequestType = CommonEnums.RequestType.ExclusionDeclarativa;
                }
                else
                {
                    qparam.RequestTypeId = CommonEnums.RequestType.Exclusion.ToInt();
