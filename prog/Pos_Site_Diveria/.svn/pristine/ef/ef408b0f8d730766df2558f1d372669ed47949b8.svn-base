...
namespace STL.POS.THProxy.NewTHService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="NewTHService.IWCFService")]
    public interface IWCFService {
        ...
        STL.POS.THProxy.NewTHService.ChannelDocumentWrapper[] executePreview(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFService/executePreview", ReplyAction="http://tempuri.org/IWCFService/executePreviewResponse")]
        System.Threading.Tasks.Task<STL.POS.THProxy.NewTHService.ChannelDocumentWrapper[]> executePreviewAsync(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data);
        ...
        int submitBatch(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFService/submitBatch", ReplyAction="http://tempuri.org/IWCFService/submitBatchResponse")]
        System.Threading.Tasks.Task<int> submitBatchAsync(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFServiceChannel : STL.POS.THProxy.NewTHService.IWCFService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFServiceClient : System.ServiceModel.ClientBase<STL.POS.THProxy.NewTHService.IWCFService>, STL.POS.THProxy.NewTHService.IWCFService {
        ...
        public STL.POS.THProxy.NewTHService.ChannelDocumentWrapper[] executePreview(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data) {
            return base.Channel.executePreview(parameters, data);
        }
        
        public System.Threading.Tasks.Task<STL.POS.THProxy.NewTHService.ChannelDocumentWrapper[]> executePreviewAsync(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data) {
            return base.Channel.executePreviewAsync(parameters, data);
        }
        
        public int submitBatch(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data) {
            return base.Channel.submitBatch(parameters, data);
        }
        
        public System.Threading.Tasks.Task<int> submitBatchAsync(STL.POS.THProxy.NewTHService.THParams parameters, byte[] data) {
