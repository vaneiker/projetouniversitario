...
namespace STL.POS.Frontend.Web.NewVersion.Controllers
{
    public partial class HomeController : BaseController
    {
        public ActionResult DocumentRequired()
        {
            ...
            ViewBag.APPLEYMODE = false;

            if (base._actionData == null)
            {
                if (SetModeLey())
                {
                    ViewBag.APPLEYMODE = SetModeLey();
                }
            }
            else if (base._actionData.Trim() == CommonEnums.AppModes.LEYMODE.ToString())
            {
                ViewBag.APPLEYMODE = true;
            }
        ...
        public JsonResult allRequiredValidated()
        {
            ...
            bool NoValidateModeLey = false;
            if (base._actionData == null)
            {
                if (SetModeLey())
                {
                    NoValidateModeLey = SetModeLey();
                }
            }
            else if (base._actionData.Trim() == CommonEnums.AppModes.LEYMODE.ToString())
            {
                NoValidateModeLey = true;
            }
            ...
            if (docReq.Any())
            {
                foreach (var d in docReq)
                {
                    if (d.Required)
                    {
                        ...
                        else if (d.DocumentId.HasValue && !d.Validated && !NoValidateModeLey)
                        {
