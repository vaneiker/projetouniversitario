...
namespace Entity.Entities
{
    public class VehicleProduct
    {
        ...
        public Nullable<decimal> minimumdepreciation { get; set; }
        public Nullable<bool> IsOverPreMium { get; set; }
        public Nullable<int> minimumdepreciationId { get; set; }
        public Nullable<int> TotalDepreciationId { get; set; }
        public Nullable<decimal> TotalDeppreciation { get; set; }
