...
namespace STL.POS.GlobalLogger
{
    public static class GLogger
    {
        ...
        private static DataTable InsertLog(GlobalLogParameter parameter)
        {
            ...
            connection = new SqlConnection(ConfigurationManager.ConnectionStrings[ConfigurationManager.AppSettings["GlobalConnectionString"]].ConnectionString);
