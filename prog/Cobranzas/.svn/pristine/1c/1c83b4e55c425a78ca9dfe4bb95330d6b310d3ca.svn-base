...
namespace KSI.Cobranza.DataLayer.EFModel
{
    ...
    public partial class LoansEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_SET_QUEUE_Result> SP_SET_QUEUE(Nullable<long> queueId, Nullable<long> accountId, Nullable<int> queueTypeId, Nullable<int> distributionId, Nullable<int> submittedByDepartmentId, Nullable<int> transferredFromDepartmentId, Nullable<int> queueStatusId, Nullable<long> vendorId, Nullable<long> assingToId, Nullable<long> transactionPaymentPlanId, Nullable<int> queueSourceId, string accountReference, Nullable<int> daysLate, Nullable<System.DateTime> actionDate, Nullable<System.DateTime> endDate, Nullable<bool> isActive, string cOMMENTS, Nullable<int> userId, string userName)
        {
            var queueIdParameter = queueId.HasValue ?
                new ObjectParameter("QueueId", queueId) :
            ...
            var distributionIdParameter = distributionId.HasValue ?
                new ObjectParameter("DistributionId", distributionId) :
                new ObjectParameter("DistributionId", typeof(int));
    
            var submittedByDepartmentIdParameter = submittedByDepartmentId.HasValue ?
                new ObjectParameter("SubmittedByDepartmentId", submittedByDepartmentId) :
                new ObjectParameter("SubmittedByDepartmentId", typeof(int));
    
            var transferredFromDepartmentIdParameter = transferredFromDepartmentId.HasValue ?
                new ObjectParameter("TransferredFromDepartmentId", transferredFromDepartmentId) :
                new ObjectParameter("TransferredFromDepartmentId", typeof(int));
            ...
            var assingToIdParameter = assingToId.HasValue ?
                new ObjectParameter("AssingToId", assingToId) :
                new ObjectParameter("AssingToId", typeof(long));
    
            var transactionPaymentPlanIdParameter = transactionPaymentPlanId.HasValue ?
                new ObjectParameter("transactionPaymentPlanId", transactionPaymentPlanId) :
                new ObjectParameter("transactionPaymentPlanId", typeof(long));
    
            var queueSourceIdParameter = queueSourceId.HasValue ?
                new ObjectParameter("QueueSourceId", queueSourceId) :
                new ObjectParameter("QueueSourceId", typeof(int));
            ...
            var daysLateParameter = daysLate.HasValue ?
                new ObjectParameter("DaysLate", daysLate) :
                new ObjectParameter("DaysLate", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SET_QUEUE_Result>("SP_SET_QUEUE", queueIdParameter, accountIdParameter, queueTypeIdParameter, distributionIdParameter, submittedByDepartmentIdParameter, transferredFromDepartmentIdParameter, queueStatusIdParameter, vendorIdParameter, assingToIdParameter, transactionPaymentPlanIdParameter, queueSourceIdParameter, accountReferenceParameter, daysLateParameter, actionDateParameter, endDateParameter, isActiveParameter, cOMMENTSParameter, userIdParameter, userNameParameter);
        }
    
        public virtual ObjectResult<SP_GET_USER_CALL_Recording_ID_Result> SP_GET_USER_CALL_Recording_ID(Nullable<int> securityUserId)
        {
            var securityUserIdParameter = securityUserId.HasValue ?
                new ObjectParameter("SecurityUserId", securityUserId) :
                new ObjectParameter("SecurityUserId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_USER_CALL_Recording_ID_Result>("SP_GET_USER_CALL_Recording_ID", securityUserIdParameter);
        }
    
        public virtual ObjectResult<GET_DOCUMENTS_Result> GET_DOCUMENTS(Nullable<long> accountId, Nullable<int> idRequirement)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("accountId", accountId) :
                new ObjectParameter("accountId", typeof(long));
    
            var idRequirementParameter = idRequirement.HasValue ?
                new ObjectParameter("IdRequirement", idRequirement) :
                new ObjectParameter("IdRequirement", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GET_DOCUMENTS_Result>("GET_DOCUMENTS", accountIdParameter, idRequirementParameter);
        }
    }
}
