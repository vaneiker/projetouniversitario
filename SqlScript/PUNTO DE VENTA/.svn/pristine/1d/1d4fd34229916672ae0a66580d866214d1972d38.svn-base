                ...
                */
                ...
                if (isActivePolicy)
                {
                    ...
                    if (base.onlyLoggedUsers)
                    {
                        ...
                        AgentByUser agentByUser = null;
                        if (currUserid != null)
                        {
                            agentByUser = oUserManager.GetAgentByUser(currUserid);
                        }

                        if (agentByUser != null)
                        {
                            userAgenCode = GetAgentInfo(agentByUser.Agent_Code.GetValueOrDefault().ToString());
                        }
                        else
                        {
                            userAgenCode = GetAgentInfo(DataCoreCustomer.Intermediario.ToString());
        ...
        public JsonResult SaveDataCotizarReno(string jsoVhnData, string jsonQtData)
        {
            ...
            try
            {
                ...
                if (getquo != null)
                {
                    ...
                    if (getquo.User_Id.HasValue)
                    {
                        qparam.user_Id = getquo.User_Id;
                    }
                }
        ...
        private Tuple<int, int, bool> SetQuotationData(string jsonQtData)
        {
            ...
            try
            {
                ...
                if (getquo != null)
                {
                    if (getquo.User_Id.HasValue)
                    {
                        param.user_Id = getquo.User_Id;
                        CallUserMethod = false;
                    }
                }
