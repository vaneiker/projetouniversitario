...
namespace STL.POS.Data.NewVersion.EdmxModel
{
    ...
    public partial class POS_SITEEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_SET_COVERAGE_DETAILS_Result> SP_SET_COVERAGE_DETAILS(Nullable<int> id, Nullable<bool> isSelected, Nullable<int> coverageDetailCoreId, string name, Nullable<decimal> amount, Nullable<decimal> minDeductible, Nullable<int> selfDamagesToProductLimits, Nullable<int> thirdPartyToProductLimits, Nullable<int> serviceType_Id, Nullable<decimal> limit, Nullable<int> userId, Nullable<decimal> deductible, Nullable<decimal> coveragePercentage, string baseDeductible, Nullable<bool> allowsToSummarize)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            var allowsToSummarizeParameter = allowsToSummarize.HasValue ?
                new ObjectParameter("AllowsToSummarize", allowsToSummarize) :
                new ObjectParameter("AllowsToSummarize", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SET_COVERAGE_DETAILS_Result>("SP_SET_COVERAGE_DETAILS", idParameter, isSelectedParameter, coverageDetailCoreIdParameter, nameParameter, amountParameter, minDeductibleParameter, selfDamagesToProductLimitsParameter, thirdPartyToProductLimitsParameter, serviceType_IdParameter, limitParameter, userIdParameter, deductibleParameter, coveragePercentageParameter, baseDeductibleParameter, allowsToSummarizeParameter);
        }
    
        public virtual ObjectResult<SP_GET_VERIFICATION_CODE_Result> SP_GET_VERIFICATION_CODE(string phoneNumber, string verificationCode)
        {
            var phoneNumberParameter = phoneNumber != null ?
                new ObjectParameter("PhoneNumber", phoneNumber) :
                new ObjectParameter("PhoneNumber", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_VERIFICATION_CODE_Result>("SP_GET_VERIFICATION_CODE", phoneNumberParameter, verificationCodeParameter);
        }
    
        public virtual int SP_SET_VERIFICATION_CODE(string phoneNumber, string verificationCode)
        {
            var phoneNumberParameter = phoneNumber != null ?
                new ObjectParameter("PhoneNumber", phoneNumber) :
                new ObjectParameter("PhoneNumber", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_SET_VERIFICATION_CODE", phoneNumberParameter, verificationCodeParameter);
        }
    
        public virtual ObjectResult<SP_GET_QUOTATIONS_NOTES_Result> SP_GET_QUOTATIONS_NOTES(Nullable<int> quotationId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("QuotationId", quotationId) :
                new ObjectParameter("QuotationId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_QUOTATIONS_NOTES_Result>("SP_GET_QUOTATIONS_NOTES", quotationIdParameter);
        }
    
        public virtual int SP_SET_DECLINED_QUOTATIONS(Nullable<int> quotationId, Nullable<int> declinedReasonId, string comment, Nullable<int> userId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("QuotationId", quotationId) :
                new ObjectParameter("QuotationId", typeof(int));
    
            var declinedReasonIdParameter = declinedReasonId.HasValue ?
                new ObjectParameter("DeclinedReasonId", declinedReasonId) :
                new ObjectParameter("DeclinedReasonId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_SET_DECLINED_QUOTATIONS", quotationIdParameter, declinedReasonIdParameter, commentParameter, userIdParameter);
        }
    
        public virtual int SP_SET_QUOTATIONS_NOTES(Nullable<int> quotationId, Nullable<int> noteReason, string comment, Nullable<int> userId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("QuotationId", quotationId) :
                new ObjectParameter("QuotationId", typeof(int));
    
            var noteReasonParameter = noteReason.HasValue ?
                new ObjectParameter("noteReason", noteReason) :
                new ObjectParameter("noteReason", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_SET_QUOTATIONS_NOTES", quotationIdParameter, noteReasonParameter, commentParameter, userIdParameter);
        }
    
        public virtual ObjectResult<SP_SET_QUOTATIONS_NOTES_GLOBAL_Result> SP_SET_QUOTATIONS_NOTES_GLOBAL(Nullable<int> quotationId, Nullable<int> noteId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("QuotationId", quotationId) :
                new ObjectParameter("QuotationId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SET_QUOTATIONS_NOTES_GLOBAL_Result>("SP_SET_QUOTATIONS_NOTES_GLOBAL", quotationIdParameter, noteIdParameter);
        }
        ...
        public virtual ObjectResult<SP_GET_QUOTATION_REFERRED_Result> SP_GET_QUOTATION_REFERRED(Nullable<int> quotationId, Nullable<int> referredId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("quotationId", quotationId) :
                new ObjectParameter("quotationId", typeof(int));
    
            var referredIdParameter = referredId.HasValue ?
                new ObjectParameter("referredId", referredId) :
                new ObjectParameter("referredId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_QUOTATION_REFERRED_Result>("SP_GET_QUOTATION_REFERRED", quotationIdParameter, referredIdParameter);
        }
    
        public virtual ObjectResult<SP_SET_QUOTATION_REFERRED_Result> SP_SET_QUOTATION_REFERRED(Nullable<int> quotationId, Nullable<int> referredId, string referredName, string referredIdentificationNumber, string referredPhone, string referredEmail, string referredPolicy)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("QuotationId", quotationId) :
                new ObjectParameter("QuotationId", typeof(int));
            ...
            var referredNameParameter = referredName != null ?
                new ObjectParameter("ReferredName", referredName) :
                new ObjectParameter("ReferredName", typeof(string));
    
            var referredIdentificationNumberParameter = referredIdentificationNumber != null ?
                new ObjectParameter("ReferredIdentificationNumber", referredIdentificationNumber) :
                new ObjectParameter("ReferredIdentificationNumber", typeof(string));
    
            var referredPhoneParameter = referredPhone != null ?
                new ObjectParameter("ReferredPhone", referredPhone) :
                new ObjectParameter("ReferredPhone", typeof(string));
    
            var referredEmailParameter = referredEmail != null ?
                new ObjectParameter("ReferredEmail", referredEmail) :
                new ObjectParameter("ReferredEmail", typeof(string));
    
            var referredPolicyParameter = referredPolicy != null ?
                new ObjectParameter("ReferredPolicy", referredPolicy) :
                new ObjectParameter("ReferredPolicy", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SET_QUOTATION_REFERRED_Result>("SP_SET_QUOTATION_REFERRED", quotationIdParameter, referredIdParameter, referredNameParameter, referredIdentificationNumberParameter, referredPhoneParameter, referredEmailParameter, referredPolicyParameter);
        }
    
        public virtual int SP_DELETE_QUOTATION_REFERRED(Nullable<int> quotationId)
        {
            var quotationIdParameter = quotationId.HasValue ?
                new ObjectParameter("quotationId", quotationId) :
                new ObjectParameter("quotationId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_DELETE_QUOTATION_REFERRED", quotationIdParameter);
        }
    
        public virtual ObjectResult<SP_GET_AGENT_BY_USER_Result> SP_GET_AGENT_BY_USER(Nullable<int> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_AGENT_BY_USER_Result>("SP_GET_AGENT_BY_USER", userIdParameter);
        }
    
        public virtual ObjectResult<SP_GET_RODUCT_TO_SHOW_POS_MODE_Result> SP_GET_RODUCT_TO_SHOW_POS_MODE(string appMode)
        {
            var appModeParameter = appMode != null ?
                new ObjectParameter("AppMode", appMode) :
                new ObjectParameter("AppMode", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GET_RODUCT_TO_SHOW_POS_MODE_Result>("SP_GET_RODUCT_TO_SHOW_POS_MODE", appModeParameter);
        }
    }
}
