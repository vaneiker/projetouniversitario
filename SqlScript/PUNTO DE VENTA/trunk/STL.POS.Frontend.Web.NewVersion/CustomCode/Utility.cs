...
namespace STL.POS.Frontend.Web.NewVersion.CustomCode
{
    public static class Utility
    {
        ...
        public static string Decrypt_Query_New(string clave)
        {
            string key = "ABCDEFG54669525PQRSTUVWXYZabcdef852846opqrstuvwxyz";
            try
            {
        ...
        public class jsonAdditionalInfo_Security
        {
            public string RedirectUrl { get; set; }
            public object RedirectRoute { get; set; }
            public object RedirectTab { get; set; }
            public string Action { get; set; }
        ...
        public class CotizarRenovacionData
        {
