    ...
    public partial class InclusionController : BaseController
    {
        ...
        public ActionResult Inclusion(String Title, bool isFromHistory)
        {
            ...
            if (LoadQuotation)
            {
                ...
                if (base.RequestType == CommonEnums.RequestType.Exclusion || base.RequestType == CommonEnums.RequestType.ExclusionDeclarativa)
                {
                    title = "EXCLUSIONES";
                }
        ...
        public JsonResult GetDataCustomerFromPolicy(string Id, string PolicyNumber, string Title = "")
        {
            ...
            if (DataCoreCustomer != null)
            {
                ...
                var firsVehiclePoliza = CheckPolicy.FirstOrDefault(x => x.EstatusPoliza == "ACTIVO" && x.EstatusItem == "ACTIVO");
                ...
                if (isActivePolicy)
                {
                    ...
                    if (Title == "EXCLUSIONES")
                    {
                        ...
                        if (firsVehiclePoliza != null)
                        {
                            ...
                            {
                                base.RequestType = CommonEnums.RequestType.ExclusionDeclarativa;
                            }
                        }
                    }
                }
        ...
        public JsonResult GetDataVehicleFromPolicy(string PolicyNumber)
        {
            ...
            //El procedure devolvera todos los vehiculos, pero a la hora de mostrar el grid solo mostrara los activos
            DataCoreVehicle = DataCoreVehicle.Where(x => x.EstatusItem == "ACTIVO").ToArray();
        ...
        public JsonResult SaveVehicleInclusion(string jsondataVehicle)
        {
            ...
            var realVehicleQty = dvehicle.Select(x => (int)x.vehicleQuantity).Cast<int>().ToList();
        ...
        public JsonResult GetVehiclesFromInclusion(string PolicyNo)
        {
            ...
            if (base.RequestType == CommonEnums.RequestType.Exclusion || base.RequestType == CommonEnums.RequestType.ExclusionDeclarativa)
            {
                ...
                if (quotData != null)
                {
                    ...
                    ExclusionStartDate = quotData.StartDate.GetValueOrDefault().ToString("yyyy-MMM-dd", CultureInfo.InvariantCulture);
                    isExlusion = true;
