...
namespace ATL.PdfSite.OnBaseBinary {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://statetrust.com/BinaryDoc", ConfigurationName="OnBaseBinary.HylandOutBoundContract")]
    public interface HylandOutBoundContract {
        ...
        ATL.PdfSite.OnBaseBinary.DocumentBytesOutput Get_document_data(ATL.PdfSite.OnBaseBinary.DocumentBytesInput DocumentData);
        
        [System.ServiceModel.OperationContractAttribute(Action="WebServicePublishing/DocData/DocumentData/Get_document_data", ReplyAction="WebServicePublishing/DocData/DocumentData/Get_document_data/response")]
        System.Threading.Tasks.Task<ATL.PdfSite.OnBaseBinary.DocumentBytesOutput> Get_document_dataAsync(ATL.PdfSite.OnBaseBinary.DocumentBytesInput DocumentData);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface HylandOutBoundContractChannel : ATL.PdfSite.OnBaseBinary.HylandOutBoundContract, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HylandOutBoundContractClient : System.ServiceModel.ClientBase<ATL.PdfSite.OnBaseBinary.HylandOutBoundContract>, ATL.PdfSite.OnBaseBinary.HylandOutBoundContract {
        ...
        public ATL.PdfSite.OnBaseBinary.DocumentBytesOutput Get_document_data(ATL.PdfSite.OnBaseBinary.DocumentBytesInput DocumentData) {
            return base.Channel.Get_document_data(DocumentData);
        }
        
        public System.Threading.Tasks.Task<ATL.PdfSite.OnBaseBinary.DocumentBytesOutput> Get_document_dataAsync(ATL.PdfSite.OnBaseBinary.DocumentBytesInput DocumentData) {
