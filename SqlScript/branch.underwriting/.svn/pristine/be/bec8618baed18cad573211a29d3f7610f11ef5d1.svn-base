...
{
    //Bmarroquin 11-02-2017 Container del pago de Cargo Automatico
    public partial class UCContainerCargoAutomatico : UC, IUC
    {
        public void edit() { }
        ...
        */
        ...
        public void save()
        {
            ...
            if (ObjServices.PaymentId.HasValue && ObjServices.PaymentId > 0)
            {
                ...
                itemDetail.AccountTypeId = int.Parse(ddlCardType.SelectedValue);// int.Parse(ddlCardType.SelectedValue); // en la tabla [Payments].[PM_PMNTS_DETAILS]  hay una FK a otra tabla sin embargo los tipos de tarjetas de credito se guardan en otra tabla...
                        ...
                        if (UCPagoConTarjetas._chkTarAlternativa.Checked)
                        {
                            if (Session["objTarjeAlter"] != null)
                            {
                                ...
                                if (ObjTarAlter.OrderId == "-99") //Esto me indica que se seteo con exito el objeto
                                {
                                    ...
                                    //ObjTarAlter.AccountTypeId = 4;// int.Parse(ddlCardType.SelectedValue); 
            ...
            , int PaymentControlId, Entity.UnderWriting.Entities.Payment.ApplyPaymentDetail Payment = null)
        {
            ...
            {
                 case "VCargoAutomatico":
                    MVCargoAutomatico.SetActiveView(VCargoAutomatico);
