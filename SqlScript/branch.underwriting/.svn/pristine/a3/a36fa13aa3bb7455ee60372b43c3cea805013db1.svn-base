<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPopPerzonalizedProfile.ascx.cs" Inherits=" WEB.NewBusiness.NewBusiness.UserControls.PlanPolicy.UCPopPerzonalizedProfile" %>
<asp:UpdatePanel ID="upPerProfile" runat="server">
    <ContentTemplate>
        <div class="pp_distribution ">
            <div class="cont" id="frmPersonalized">
                <div class="wd49 fl mR-2-p mB">
                    <div>
                        <label class="label" runat="server" id="PolicyNo">Policy #:</label>
                        <asp:TextBox ID="txtIPPolicy" runat="server" ReadOnly="true" validation="Required"></asp:TextBox>
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="label" runat="server" id="InvestmentProfile">Investment Profile:</label>
                        <asp:TextBox ID="txtIPInvestmentProfile" runat="server" ReadOnly="true" validation="Required"></asp:TextBox>
                    </div>
                </div>
                <div class=" wd49 fl mB15">
                    <div>
                        <label class="label" runat="server" id="Currency">Currency:</label>
                        <asp:TextBox ID="txtIPCurrency" runat="server" ReadOnly="true" validation="Required"></asp:TextBox>
                    </div>
                    <div>
                        <label class="label" runat="server" id="PlanType">Plan Type:</label>
                        <asp:TextBox ID="txtIPPlanType" runat="server" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div>
                        <label class="label" runat="server" id="ProfileType">Profile Type:</label>
                        <asp:TextBox ID="txtIPProfileType" runat="server" ReadOnly="true" validation="Required"></asp:TextBox>
                    </div>
                </div>
                <label class="label wd100 txtBold fl" runat="server" id="ProfileDistribution">Profile Distribution</label>
                <div class="data_G tbl wd100 fl" style="max-height: 430px; overflow-y: scroll;">
                    <asp:GridView ID="gvPopProfileDistribution" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                        DataKeyNames="SymbolId, InvstProductDate, InvestmentProfileDate, StockExchangeId, ProjectionRate, InvestmentCurrency,
                         MinPercentAllowed, MaxPercentAllowed,  InitialValidDate, EndValidDate, Symbol, SymbolDesc">
                        <Columns>
                    ...
                    <table>
                        <tr class="gradient_gris">
                            ...
                            <td align="right" class="c2">
                                <div class="pdR" runat="server" iD="TOTALDISTRIBUTION">TOTAL DISTRIBUTION</div>
                            </td>
