...
namespace WEB.NewBusiness.Common
{
    public static class EnumerableExtender
    {
        ...
        private static CallSite<Func<CallSite, object, object>> GetCallSiteLocked(string name)
        {
            ...
            if (callSite == null)
            {
                callSites[name] = callSite = CallSite<Func<CallSite, object, object>>.Create(
                            Binder.GetMember(CSharpBinderFlags.None, name, typeof(EnumerableExtender),
        ...
        {
            return Enumerable.OrderBy<dynamic, object>(source, EnumerableExtender.GetAccessor(property), Comparer<object>.Default);
        }

        public static IOrderedEnumerable<dynamic> OrderByDescending(this IEnumerable<dynamic> source, string property)
        {
            return Enumerable.OrderByDescending<dynamic, object>(source, EnumerableExtender.GetAccessor(property), Comparer<object>.Default);
        }

        public static IOrderedEnumerable<dynamic> ThenBy(this IOrderedEnumerable<dynamic> source, string property)
        {
            return Enumerable.ThenBy<dynamic, object>(source, EnumerableExtender.GetAccessor(property), Comparer<object>.Default);
        }

        public static IOrderedEnumerable<dynamic> ThenByDescending(this IOrderedEnumerable<dynamic> source, string property)
        {
            return Enumerable.ThenByDescending<dynamic, object>(source, EnumerableExtender.GetAccessor(property), Comparer<object>.Default);
        }
    }
}