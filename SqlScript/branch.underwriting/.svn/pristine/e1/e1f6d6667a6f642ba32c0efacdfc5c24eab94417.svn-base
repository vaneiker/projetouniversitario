...
namespace WSVirtualOffice.Models.querydata
{
    class PortfolioApproval
    {
        ...
        public PortfolioApproval(Int64 customerno, String originalagent, String newagent, String name, double annualpremium, double benefitamount, String disillustrationno, String planname, String status, Int32 userid, Int64 customerplanno)
        {
        ...
        {
            get { return originalagent; }
            set { originalagent = value; }
        }
