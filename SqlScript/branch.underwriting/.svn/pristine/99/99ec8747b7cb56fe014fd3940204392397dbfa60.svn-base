...
{
    public partial class UCBEmailPhone : WEB.UnderWriting.Common.UC, WEB.UnderWriting.Common.IUC
    {  
        ...
        public void fillDropDownEmailPhones() {
            Service.DropDowns.GetDropDown(ref PrimaryBeneficiaryEmail,
                                           Language.English,
            ...
            UnderWriting.Common.Tools.SelectIndexByValue(ref PrimaryBeneficiaryEmail, "-1", true);
            Service.DropDowns.GetDropDown(ref BDDLPhoneType, Language.English, DropDownType.PhoneType, Service.Corp_Id, projectId: Service.ProjectId, companyId: Service.CompanyId);
            Service.DropDowns.GetDropDown(ref BEmailTypeDDL, Language.English, DropDownType.EmailType, Service.Corp_Id, projectId: Service.ProjectId, companyId: Service.CompanyId);

        }

        private void fillPhone(IEnumerable<Entity.UnderWriting.Entities.Contact.Phone> PhoneList = null)
        {
            var Contact = Convert.ToInt32(PrimaryBeneficiaryEmail.Text);
            var phoneData = PhoneList == null ? Services.ContactManager.GetCommunicatonPhone(Service.Corp_Id, Contact, Service.LanguageId) : PhoneList;
        ...
        {
            var Contact = Convert.ToInt32(PrimaryBeneficiaryEmail.Text);
            var emailData = EmailList ?? Services.ContactManager.GetCommunicatonEmail(Service.Corp_Id, Contact, Service.LanguageId);
        ...
        protected void EmailBeneficiaries_SelectedIndexChanged(Object sender, EventArgs e)
        {
            var contactSelected = Convert.ToInt32(PrimaryBeneficiaryEmail.Text);

             if (contactSelected > 0)
             {
                 var emailData = Services.ContactManager.GetCommunicatonEmail(Service.Corp_Id, contactSelected, Service.LanguageId);
             ...
             var phoneData = Services.ContactManager.GetCommunicatonPhone(Service.Corp_Id, contactSelected, Service.LanguageId);
        ...
        protected void AddPhoneBTN_Click(Object sender, EventArgs e)
        {
            ...
            int id = Services.ContactManager.SetPhone(new Entity.UnderWriting.Entities.Contact.Phone
            {
                ...
                DirectoryId = -1,
                DirectoryTypeId = Convert.ToInt32(this.BDDLPhoneType.SelectedValue.Split('|')[1]),
                DirectoryDetailId = -1,
                CountryCode = this.BCountryCodeTxt.Text,
                AreaCode = this.BAreaCodeTxt.Text,
                PhoneNumber = this.BPhoneNumberTxt.Text,
        ...
        protected void UpdatePhone(Object sender, EventArgs e)
        {
            ...
            UnderWriting.Common.Tools.SelectIndexByValue(ref BDDLPhoneType, gvPhone.DataKeys[RowIndex]["CorpId"].ToString() + "|" + gvPhone.DataKeys[RowIndex]["DirectoryTypeId"].ToString(), false);
            this.BCountryCodeTxt.Text = gvPhone.DataKeys[RowIndex]["CountryCode"] == null ? "" : gvPhone.DataKeys[RowIndex]["CountryCode"].ToString();
            this.BAreaCodeTxt.Text = gvPhone.DataKeys[RowIndex]["AreaCode"] == null ? "" : gvPhone.DataKeys[RowIndex]["AreaCode"].ToString();
            this.BPhoneNumberTxt.Text = gvPhone.DataKeys[RowIndex]["PhoneNumber"] == null ? "" : gvPhone.DataKeys[RowIndex]["PhoneNumber"].ToString();
        ...
        protected void AddEmailBTN_Click(Object sender, EventArgs e)
        {
            ...
            var id = Services.ContactManager.SetEmail(new Entity.UnderWriting.Entities.Contact.Email
            {
                CorpId = Service.Corp_Id,
                DirectoryId = -1,
                DirectoryTypeId = Convert.ToInt32(this.BEmailTypeDDL.SelectedValue.Split('|')[1]),
                DirectoryDetailId = -1,
                EmailAdress = this.BEmailAddressTxt.Text,
                IsPrimary = this.BEmailPrimaryChk.Checked,
        ...
        protected void UpdateEmail(Object sender, EventArgs e)
        {
            ...
            UnderWriting.Common.Tools.SelectIndexByValue(ref BEmailTypeDDL, gvEmail.DataKeys[RowIndex]["CorpId"].ToString() + "|" + gvEmail.DataKeys[RowIndex]["DirectoryTypeId"].ToString(), false);
            this.BEmailAddressTxt.Text = gvEmail.DataKeys[RowIndex]["EmailAdress"].ToString();
            this.BEmailPrimaryChk.Checked = Convert.ToBoolean(gvEmail.DataKeys[RowIndex]["IsPrimary"]);
        ...
        public void EmptyEmailControls()
        {
            ...
            this.BEmailPrimaryChk.Checked = false;
            this.BEmailAddressTxt.Text = string.Empty;
            UnderWriting.Common.Tools.SelectIndexByValue(ref BEmailTypeDDL, "-1", false);
            BEmailTypeDDL.SelectedIndex = -1;
        ...
        public void EmptyPhoneControls()
        {
            ...
            this.BCountryCodeTxt.Text = string.Empty;
            this.BAreaCodeTxt.Text = string.Empty;
            this.BPhoneNumberTxt.Text = string.Empty;
            this.ExtensionTxt.Text = string.Empty;
            this.ContactTxt.Text = string.Empty;
            UnderWriting.Common.Tools.SelectIndexByValue(ref BDDLPhoneType, "-1", false);
