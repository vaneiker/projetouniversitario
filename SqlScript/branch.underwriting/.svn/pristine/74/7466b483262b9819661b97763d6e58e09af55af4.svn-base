<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContainerTransferCheck.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCContainerTransferCheck" %>
...
<div class="content_fondo_blanco" id="frmPay">
    ...
    <div class="grupos de_2">
        ...
        <div>
            <label class="label red" runat="server" id="CheckNumber">Check Number</label>
            <asp:TextBox ID="txtCheckNumber" runat="server" validation="Required"></asp:TextBox>
        </div>
        <div>
            <label class="label red" runat="server" id="CheckDate">Check Date</label>
            <asp:TextBox ID="txtCheckDate" runat="server" validation="Required" CssClass="datepicker"></asp:TextBox>
        </div>
        <div>
            <label class="label red" runat="server" id="BankName">Bank Name</label>
            <asp:TextBox ID="txtBankName" runat="server" validation="Required" Enabled="false"></asp:TextBox>
        </div>
        <div>
