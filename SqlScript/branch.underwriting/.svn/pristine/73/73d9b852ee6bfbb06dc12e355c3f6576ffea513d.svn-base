<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RETIRO.ascx.cs" Inherits="WEB.UnderWriting.Case.UserControls.PolicyPlanData.ProductControls.RETIRO" %>
<ul class="secundario">
    <li class="ppinfo">
        <div id="dvPlPnRetiro">
            ...
            <div class=" wd100 fl mB">
                <div class=" boxes mR-2-p">
                    ...
                    <label class="label">
                        Retirement Period:</label>
                    <asp:TextBox ID="txtRetirementPeriod" runat="server" class="" Enabled="false"></asp:TextBox>
                </div>
                <div class=" boxes mR-2-p">
                    <label class="label">
                    ...
                    <asp:TextBox ID="txtRetirementAge" runat="server" class="" Enabled="false"></asp:TextBox>
                </div>
                <div class=" boxes mR-2-p">
                    <label class="label">
                    ...
                    <asp:DropDownList ID="ddlInvestmentProfile" runat="server" alt="dvPlPnRetiro" onChange="BtnProfileVisiblility(this);">
                    </asp:DropDownList>
                    <label class="label">
