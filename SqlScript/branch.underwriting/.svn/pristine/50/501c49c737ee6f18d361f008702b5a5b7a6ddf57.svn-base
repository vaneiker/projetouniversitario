...
{
    public partial class UCContainerTransferCheck : WEB.NewBusiness.Common.UC
    {
        ...
        public void Translator(string Lang)
        {
            ...
            CheckNumber.InnerHtml = Resources.CheckNumber;
            CheckDate.InnerHtml = Resources.CheckDate;
