<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCFieldFooterLighthouse.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.WUCFieldFooterLighthouse" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnFooter" class="col-1-1" ClientIDMode="Static">
            <div class="barra_azul_celeste">
                <div class='<%= "grupos de_6 alingTopFun" + ObjServices.Language.ToString() %>' style="display:flex; align-items: flex-end;">
                    <div>
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtInsuredAmount" ClientIDMode="Static" runat="server" TabIndex="0" decimal="decimal" AllowEnter="false" validation="Required" onkeydown="if (event.keyCode == 13) return false;"></asp:TextBox>
                    </div>
                    <div>
                        <label class="label" runat="server" id="TargetAnnualPremium">Target Annual Premium</label>
                        <asp:TextBox ID="txtTargetAnnualPremium" runat="server" ClientIDMode="Static" TabIndex="3" decimal="decimal" AllowEnter="false" validation="Required" onkeydown="if (event.keyCode == 13) return false;"></asp:TextBox>
                    </div>
                </div>
                <!--grupos-->
            </div>
