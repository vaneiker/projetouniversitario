...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class SP_GET_PIVOTFTDATAREPORT_PRIMAS_COBRADAS_Result
    {
        ...
        public Nullable<decimal> PrimacobradaSinImpuesto { get; set; }
        public Nullable<decimal> PrimaCobrada { get; set; }
