...
{
    public partial class UCContainerCCDomicile : WEB.NewBusiness.Common.UC
    {
        ...
        public void Translator(string Lang)
        {
            ...
            CardholderName.InnerHtml = Resources.CardholderName;
            ExpirationDate.InnerHtml = Resources.ExpirationDate;
            CardNumber.InnerHtml = Resources.CardNumber;
            RepeatCardNumber.InnerHtml = Resources.Repeat + " " + Resources.CardNumber;
            CIDorCVVN2.InnerHtml = "CID" + Resources.or + " CVV #2";
            RepeatCIDorCVVN2.InnerHtml = Resources.Repeat + " CID " + Resources.or + " CVV #2";
            CardholderRelationshipOwnerInsured.InnerHtml = Resources.CardHolderRelationshipOwnerInsured;
