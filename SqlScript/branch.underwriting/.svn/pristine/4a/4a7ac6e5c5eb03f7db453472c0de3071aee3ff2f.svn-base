<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCACHDomicile.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCACHDomicile" %>
...
<div class="content_fondo_blanco" id="frmPay">
    ...
    <div class="grupos de_2">
        ...
        <div>
            ...
            <asp:TextBox ID="txtABANumber" runat="server" validation="Required" ClientIDMode="Static"></asp:TextBox>
        </div>
        <div>
