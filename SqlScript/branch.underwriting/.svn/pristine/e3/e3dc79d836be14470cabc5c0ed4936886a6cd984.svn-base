...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class SP_SET_PL_PCY_STATUS_CHANGE_VEH_Result
    {
        ...
        public Nullable<int> Status_Change_Type_Id { get; set; }
        public Nullable<int> Policy_Status_Id { get; set; }
        public Nullable<int> Status_Change_Id { get; set; }
    }
}
