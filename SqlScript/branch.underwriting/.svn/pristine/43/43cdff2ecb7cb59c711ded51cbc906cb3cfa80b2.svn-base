...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class SP_SET_PL_POLICY_VEHICLE_INSURED1_Result
    {
        ...
        public Nullable<int> Policy_Change_Id { get; set; }
        public Nullable<int> Insured_Vehicle_Id { get; set; }
        public Nullable<int> Insured_Ve_Change_Id { get; set; }
    }
}
