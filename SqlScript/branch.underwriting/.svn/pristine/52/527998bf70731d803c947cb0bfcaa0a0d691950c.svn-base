...
{
    public partial class UCContainerTransferWire : WEB.NewBusiness.Common.UC
    {
        ...
        public void Translator(string Lang)
        {
            ...
            WireConfirmationNumber.InnerHtml = Resources.ConfirmationNumber;
            WireDueDate.InnerHtml = Resources.DueDate;
