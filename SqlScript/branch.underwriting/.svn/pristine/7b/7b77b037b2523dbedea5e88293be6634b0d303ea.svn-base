<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCFieldFooterSelect.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.WUCFieldFooterSelect" %>
            ...
            <div class="barra_azul_celeste">
                <div class='<%= "grupos de_6 alingtoend alingTopFun" + ObjServices.Language.ToString() %>' >
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtInsuredAmount" ClientIDMode="Static" runat="server" TabIndex="0" decimal="decimal" ReadOnly="true" AllowEnter="false" validation="Required"></asp:TextBox>
                    </div>
                    <div>
