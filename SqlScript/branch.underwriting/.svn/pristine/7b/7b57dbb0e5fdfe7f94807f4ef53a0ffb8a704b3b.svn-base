<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCLighthouse.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.Illustration.PlanInformation.UCLighthouse" %>
<ul>
    <li>
