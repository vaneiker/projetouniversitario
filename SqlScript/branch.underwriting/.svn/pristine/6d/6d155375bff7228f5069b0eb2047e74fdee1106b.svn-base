<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCBail.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.IllustrationAlliedLines.Products.UCBail" %>
<%@ Register Assembly="DevExpress.Web.v14.2, Version=14.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/NewBusiness/UserControls/IllustrationAlliedLines/UCBailDetail.ascx" TagPrefix="uc1" TagName="UCBailDetail" %>
...
<dx:ASPxGridView
    ...
    KeyFieldName="UniqueBailId;InsuredAmount"
    ClientIDMode="Static"
    AutoGenerateColumns="false"
    Width="100%"
    OnRowCommand="gvAlliedLinesDetail_RowCommand"
    OnPreRender="gvBailDetail_PreRender">
    <Columns>
                    ...
                    <ContentTemplate>
                        <div style="text-align: center">
                            <asp:LinkButton
                                runat="server"
                                ID="lnkEdit"
                                CommandName="EditBail" CssClass="view_file">
                            </asp:LinkButton>
                        </div>
                    </ContentTemplate>
                    <Triggers>
        ...
        <%--        <dx:GridViewDataTextColumn Caption="Vigency" FieldName="Vigency" Name="Vigency" CellStyle-HorizontalAlign="Center" VisibleIndex="1">
            <Settings AllowHeaderFilter="False" AllowSort="true" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Reinsurance" FieldName="ReinsuranceDesc" Name="Reinsurance" CellStyle-HorizontalAlign="Center" VisibleIndex="2">
            <Settings AllowHeaderFilter="False" AllowSort="true" />
        </dx:GridViewDataTextColumn>--%>
        <dx:GridViewDataTextColumn Caption="BailTypeLabel" FieldName="Bailtype" Name="BailTypeLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="1">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="BuninessTypeLabel" FieldName="Businesstype" Name="BuninessTypeLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="2">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>

        <dx:GridViewDataTextColumn Caption="pól. Princ." FieldName="PolicyNoMain" Name="PolicyNumberMain" Visible="false" CellStyle-HorizontalAlign="Center" VisibleIndex="3">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Plan" FieldName="ProductDesc" Name="PlanLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="4">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Monto Asegurado" FieldName="InsuredAmountF" Name="InsuredAmount" CellStyle-HorizontalAlign="Center" VisibleIndex="5">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Prima sin Impuesto" FieldName="PremiumAmountF" Name="PremiumWithoutTax" CellStyle-HorizontalAlign="Center" VisibleIndex="6">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataColumn Caption="Cobertura" Name="Coverage" Width="100" Visible="false" VisibleIndex="7">
            <DataItemTemplate>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div style="text-align: center">
        ...
        <dx:GridViewDataColumn Caption="Endoso" Name="Endorsement" Width="100" VisibleIndex="8">
            <DataItemTemplate>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div style="text-align: center">
...
<asp:ModalPopupExtender ID="ModalPopupCoverage" PopupControlID="popCoverage" DropShadow="false" BackgroundCssClass="ModalBackgroud3" TargetControlID="hdnBailCoverages" BehaviorID="BailupBhvrnavyCoverages" runat="server"></asp:ModalPopupExtender>
    ...
    <div class="pop_up_wrapper" style="width: 936px; height: 775px; overflow-x: hidden; overflow-y: hidden">
        ...
        <div class="titulos_azules head_contengridproxi PreviewPDF" style="width: 100%;">
            <ul>
                ...
                <li style="top: 13%;">
                    <input type="button" id="close_pop_up" class="cls_pup" style="background-color: transparent; border: none;" onclick="CloseBailCoverage();" />
                </li>
            </ul>
        </div>
...
<asp:ModalPopupExtender ID="mpeBailDetail" PopupControlID="pnBailDetail" DropShadow="false" BackgroundCssClass="ModalBackgroud3" TargetControlID="hdnPopBailDetail" BehaviorID="popupBhvrBailDetail" runat="server"></asp:ModalPopupExtender>
<asp:Panel runat="server" ID="pnBailDetail" CssClass="modalPopup" ClientIDMode="Static" Style="display: none">
    <div class="pop_up_wrapper" style="width: 1776px; height: 650px; overflow-x: hidden; overflow-y: hidden">
        <!--escriben por style el ancho que desean-->
        <div class="titulos_azules head_contengridproxi PreviewPDF" style="width: 100%;">
            <ul>
                <li style="position: absolute; left: 41%; top: 31%;">
                ...
                <li style="top: 13%;">
                    <input type="button" id="close_pop_up" class="cls_pup" style="background-color: transparent; border: none;" onclick="ClosePopBailDetail();" />
                </li>
            </ul>
        </div>
        <!--titulos_azules-->
        <uc1:UCBailDetail runat="server" ID="UCBailDetail" />
        <!--content_fondo_blanco-->
    </div>
</asp:Panel>
...
<asp:HiddenField runat="server" ID="hdnBailCoverages" Value="false" ClientIDMode="Static" />
<asp:HiddenField runat="server" ID="hdnPopBailDetail" Value="false" ClientIDMode="Static" />
