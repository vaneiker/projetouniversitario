<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCFieldFooterCompassIndex.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.WUCFieldFooterCompassIndex" %>
            ...
            <div class="barra_azul_celeste">
                <div class="grupos de_7 alingtoend">
                    <div>
                        ...
                        <asp:TextBox ID="txtInsuredAmount" runat="server" TabIndex="0" ClientIDMode="Static" decimal="decimal"  AllowEnter="false" validation="Required"></asp:TextBox>
                    </div>                   
                    <div>
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtMinimumAnnualPremium" runat="server" TabIndex="4" ClientIDMode="Static" decimal="decimal" AllowEnter="false" validation="Required"></asp:TextBox>
                    </div>
                     <div>
