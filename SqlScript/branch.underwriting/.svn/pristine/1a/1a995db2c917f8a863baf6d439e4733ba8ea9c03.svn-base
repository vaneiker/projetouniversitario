...
var divImageLoading = '<div id="loading2Image" class="LoadingEn" style="display: none;z-index: 99999999;"> <iframe src="about:blank" style="border:none; top: 0; left: 0; height:100%; width:100%; z-index:-1; position: absolute;"/></div> ';
...
BeginRequestHandler = function (sender, args) {
    ...
    if (Lang == "es")
        $("#loading2Image").removeClass("LoadingEn").addClass("LoadingEs");
    else
        $("#loading2Image").removeClass("LoadingEs").addClass("LoadingEn");
            ...
            if ($this.is("input[type='text']")) {
                ...
                if (validateEqualControlId != null && validateEqualControlId != "") {
                    if ($("#" + validateEqualControlId).val() != $this.val()) {
                        ...
                        if (!changeMessage)
                            oMessage.ErrorType = "validateEqualControlId";
                        else
                            oMessage.ErrorType = $this.attr("label");
