...
{
    public partial class VerificacionFuncionamiento : UC, IUC
    {
        ...
        public void Initialize()
        {
            ...
            }).Where(c => c.GroupId.GetValueOrDefault().Equals(Utility.ReviewGroups.VerificarFuncionamientoVehiculo.ToInt())).ToList();
                ...
                foreach (var option in options)
                {
                    foreach (var control in this.Controls)
                    {
                        ...
                        if (control is RadioButton)
                        {
                            ...
                            if (ItemId == option.ItemId && OptionDesc == option.OptionDesc)
                            {
