<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCLegacy.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.Illustration.PlanInformation.UCLegacy" %>
<ul>
    <li>
