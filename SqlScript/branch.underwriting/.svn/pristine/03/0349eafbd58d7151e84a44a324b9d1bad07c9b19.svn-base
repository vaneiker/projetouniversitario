<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContinent.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCContinent" %>



        <div class="tbl data_G mB">
         
               <asp:GridView ID="gvContinent"
                runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvContinent_PageIndexChanging">
                <Columns>

                    <asp:TemplateField HeaderText="Continent Name" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="c1" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="c1">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Continent_Desc") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
 ...
 <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtNewContinent', '#pnContinent')" value="Add Continent">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnContinent" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtNewSContinent" ClientIDMode="Static" runat="server" placeholder="Add Continent..." CssClass="row mB" />
