...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class sp_get_customerPlandet_Result
    {
        ...
        public Nullable<int> ContributionPeriod_Month { get; set; }
        public string Destination_Of_Funds { get; set; }
        public Nullable<decimal> FractionSurcharge { get; set; }
    }
}
