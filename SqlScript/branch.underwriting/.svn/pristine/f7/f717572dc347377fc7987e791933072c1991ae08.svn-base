...
namespace WEB.NewBusiness.Common.Illustration.BusinessLogic
{
    ...
    public class IMaintermfixed
    {
        ...
        public IMaintermfixed(Entity.UnderWriting.IllusData.Illustrator.CustomerDetail customer,
            ...
            IllustrationService illustrationService)
        {
                ...
                this.investmentprofilecode = customerPlanDetail.InvestmentProfileCode[0];// Invprofiledata.getInvestmentprofilecode(this.investmentprofile);
                ...
                this.growthrate = _rulesService.GetValue(RulesService.Rules.ADMIN_FIXED);
                ...
                if (customerPlanDetail.RiderAdb != null)
                {
                ...
                if (customerPlanDetail.RiderAcdb != null)
                {
                ...
                if (customerPlanDetail.RiderCi != null)
                {
                ...
                if (customerPlanDetail.RiderTerm != null)
                {
                    int temptermnumyears = 0;
                    if (customerPlanDetail.TermContributionTypeCode[0] == 'U')
                        temptermnumyears = customerPlanDetail.RiderTermUntilAge - this.age + 1;
                    else if (customerPlanDetail.TermContributionTypeCode[0] == 'C')
                        temptermnumyears = this.numberofyears;
                    else if (customerPlanDetail.TermContributionTypeCode[0] == Contributiontypes.NUMBEROFYEARS)
                        temptermnumyears = customerPlanDetail.RiderTermUntilAge;
                    if (temptermnumyears > this.numberofyears)
                        temptermnumyears = this.numberofyears;

                    this.ridertermamount = customerPlanDetail.RiderTerm == "Y" ? customerPlanDetail.RiderTermAmount.ToDouble() : 0;
                    this.ridertermuntilage = temptermnumyears;
                    this.ridertermcost = customerPlanDetail.RiderTermCost.ToDouble();
                }

                if (customerPlanDetail.RiderOir != null)
                {
                    if (customerPlanDetail.RiderOir[0] == 'Y')
                    {
                        ...
                        this.ridercicode = rideroircode = customerPlanDetail.RiderOir[0];

                        if (this.rideroircode == 'Y')
                        {
                            this.rideroiramount = othins.RideroirAmount.ToDouble();

                            this.oirage = othins.Age.GetValueOrDefault();
                            this.oirgendercode = othins.GenderCode[0];
                            this.oirsmokercode = othins.Smoker[0];

                            this.oiruntilage = othins.UntilAge;

                            this.oiractivityrisktypevalue = Utility.GetIllusDropDownByType(Utility.DropDownType.ActivityRiskType, productcode)
                            .Single(o => o.ActivityRiskTypeNo == othins.ActivityRiskTypeNo).ActivityRiskValue.ToDouble();

                            this.oirhealthrisktypevalue = Utility.GetIllusDropDownByType(Utility.DropDownType.HealthRiskType, productcode)
                                .Single(o => o.HealthRiskTypeNo == othins.HealthRiskTypeNo).HealthRiskValue.ToDouble();
                        }
                        else
                        {
                        ...
                        int tempoiryears = 0;
                        if (othins.ContributionTypeCode[0] == 'U')
                            tempoiryears = othins.UntilAge - othins.Age.GetValueOrDefault() + 1;
                        else if (othins.ContributionTypeCode[0] == 'C')
                            tempoiryears = this.numberofyears;
                        else if (othins.ContributionTypeCode[0] == Contributiontypes.NUMBEROFYEARS)
                ...
                this.primarymortdatatable = Mortalityrates.getMortalitydatafixedterm(this.productcode, this.gendercode.ToString(), Ridertypes.Primary.ToString(), this.smokercode.ToString(), this.healthrisktypevalue, this.activityrisktypevalue, this.countryrisk, _rulesService, illustrationService);
                this.othermortdatatable = Mortalityrates.getMortalitydatafixedterm(this.productcode, this.oirgendercode.ToString(), Ridertypes.Primary.ToString(), this.oirsmokercode.ToString(), this.oirhealthrisktypevalue, this.oiractivityrisktypevalue, this.countryrisk, _rulesService, illustrationService);
                ...
                {
                    canceldata = Productdata.getProductcanceldata(this.productcode, this.retirementnoofyears, illustrationService);
                    setVivodata();
                    setRemaindata();
                }
        ...
        public void setRuledata()
        {
            ...
            GSMaximuminsuranceamount = _rulesService.GetValue(RulesService.Rules.GS_MAXIMUM_INSURED_AMOUNT);
            GSMinimuminsuranceamount = _rulesService.GetValue(RulesService.Rules.GS_MINIMUM_INSURED_AMOUNT);
            ...
            Extratermpenalty = _rulesService.GetValue(RulesService.Rules.EXTRA_TERM_PENALTY);


            this.Adbmaxage = _rulesService.GetValue(RulesService.Rules.ADB_MAX_AGE).ToInt();
            this.Adbfactor = _rulesService.GetValue(RulesService.Rules.ADB_FACTOR);
            this.Minimumridercost = _rulesService.GetValue(RulesService.Rules.MINIMUM_RIDER_COST);
            ...
            this.Targetrate = _rulesService.GetValue(RulesService.Rules.TARGET_RATE);

            this.Targetfactor = _rulesService.GetValue(RulesService.Rules.TARGET_FACTOR);



            this.Regularmargin = _rulesService.GetValue(RulesService.Rules.REGULAR_MARGIN);
            this.Savingsmargin = _rulesService.GetValue(RulesService.Rules.SAVINGS_MARGIN);
            this.Ridersmargin = _rulesService.GetValue(RulesService.Rules.RIDERS_MARGIN);
            this.Minimumfirstagetarget = _rulesService.GetValue(RulesService.Rules.MINIMUM_FIRST_AGE_TARGET);
            this.Minimumfirstbaseprice = _rulesService.GetValue(RulesService.Rules.MINIMUM_FIRST_BASE_PRICE);
            this.Minimumsecondbaseprice = _rulesService.GetValue(RulesService.Rules.MINIMUM_SECOND_BASE_PRICE);
            this.insuranceunderage = _rulesService.GetValue(RulesService.Rules.INSURANCE_UNDERAGE).ToInt();
        ...
        */
        ...
        public double getMinimumInsurancecost(double tempinsuranceamount)
        {
            ...
            /*
             *commented to change according to German Logic 
