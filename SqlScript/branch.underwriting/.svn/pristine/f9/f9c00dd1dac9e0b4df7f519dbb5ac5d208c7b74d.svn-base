<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContainerTransferWire.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCContainerTransferWire" %>
