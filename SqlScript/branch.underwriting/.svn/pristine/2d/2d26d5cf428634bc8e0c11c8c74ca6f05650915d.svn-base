...
namespace WEB.NewBusiness.ServicesApi.PolicyIllustrationService {
    ...
    public interface IPolicyIllustrationService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPolicyIllustrationService/SetGroupPolicyInformation", ReplyAction="http://tempuri.org/IPolicyIllustrationService/SetGroupPolicyInformationResponse")]
        WEB.NewBusiness.ServicesApi.PolicyIllustrationService.ReturnMessageData SetGroupPolicyInformation(string customerPlanNo, string corpId, string regionId, string countryId, string domesticregId, string stateProvId, string cityId, string officeId, string userId, string companyId, string projectId, bool isChangingInUW);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPolicyIllustrationService/SetGroupPolicyInformation", ReplyAction="http://tempuri.org/IPolicyIllustrationService/SetGroupPolicyInformationResponse")]
        System.Threading.Tasks.Task<WEB.NewBusiness.ServicesApi.PolicyIllustrationService.ReturnMessageData> SetGroupPolicyInformationAsync(string customerPlanNo, string corpId, string regionId, string countryId, string domesticregId, string stateProvId, string cityId, string officeId, string userId, string companyId, string projectId, bool isChangingInUW);
    }
    ...
    public partial class PolicyIllustrationServiceClient : System.ServiceModel.ClientBase<WEB.NewBusiness.ServicesApi.PolicyIllustrationService.IPolicyIllustrationService>, WEB.NewBusiness.ServicesApi.PolicyIllustrationService.IPolicyIllustrationService {
        ...
        public WEB.NewBusiness.ServicesApi.PolicyIllustrationService.ReturnMessageData SetGroupPolicyInformation(string customerPlanNo, string corpId, string regionId, string countryId, string domesticregId, string stateProvId, string cityId, string officeId, string userId, string companyId, string projectId, bool isChangingInUW) {
            return base.Channel.SetGroupPolicyInformation(customerPlanNo, corpId, regionId, countryId, domesticregId, stateProvId, cityId, officeId, userId, companyId, projectId, isChangingInUW);
        }
        
        public System.Threading.Tasks.Task<WEB.NewBusiness.ServicesApi.PolicyIllustrationService.ReturnMessageData> SetGroupPolicyInformationAsync(string customerPlanNo, string corpId, string regionId, string countryId, string domesticregId, string stateProvId, string cityId, string officeId, string userId, string companyId, string projectId, bool isChangingInUW) {
            return base.Channel.SetGroupPolicyInformationAsync(customerPlanNo, corpId, regionId, countryId, domesticregId, stateProvId, cityId, officeId, userId, companyId, projectId, isChangingInUW);
        }
    }
}
