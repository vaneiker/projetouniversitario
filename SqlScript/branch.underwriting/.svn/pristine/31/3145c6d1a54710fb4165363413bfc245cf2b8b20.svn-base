<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAxys.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.Illustration.PlanInformation.UCAxys" %>
             <ul>
                    <li>
                                ...
                                <div class="col-1-2">
                                    <div class="grupos de_2">
                                        <div>
                                            ...
                                            <div class="wrap_select">
                                                <asp:DropDownList runat="server" ID="ddlPlanType">
                                                    <asp:ListItem Text="Axys" />
                                        ...
                                        <div>
                                            ...
                                            <div class="wrap_select">
                                                <asp:DropDownList runat="server" ID="ddlFrequencyPayment">
                                                    <asp:ListItem Text="Option 1" />
                                                    <asp:ListItem Text="Option 2" />
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div>
                                            <label class="label"><%=RESOURCE.UnderWriting.NewBussiness.Resources.InvestmentProfile %></label>
                                            <div class="wrap_select">
                                                <asp:DropDownList runat="server" ID="ddlInvestmentProfile">
                                                    <asp:ListItem Text="Option 1" />
                                                    <asp:ListItem Text="Option 2" />
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div>
                                            <label class="label"><%=RESOURCE.UnderWriting.NewBussiness.Resources.RetirementPeriod %></label>
                                            <div class="wrap_select">
                                    ...
                                    <div class="grupos de_2">
                                        ...
                                        <div id="divInitialContribution">
                                            ...
                                            <asp:TextBox runat="server" ID="txtInitialContributionAmount" ClientIDMode="Static" />
                                        </div>
                                    </div>
