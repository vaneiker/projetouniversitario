...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class SP_GET_DEDUCTIBLE_PIVOT_Result
    {
        public Nullable<int> NO { get; set; }
        public Nullable<int> dateNo { get; set; }
        public string datename { get; set; }
        public Nullable<int> year { get; set; }
        public decimal ClaimValue { get; set; }
        public decimal DeductibleAmountPaid { get; set; }
        public decimal AmountPaidByCompany { get; set; }
