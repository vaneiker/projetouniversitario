<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCEndosoCesion.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.IllustrationsVehicle.UCEndosoCesion" %>
        ...
        <div id="dvEndosoCesion">
            ...
            <div class="">
                ...
                <div class="label_plus_input par">
                    ...
                    <asp:TextBox runat="server" ID="txtBeneficiario" ClientIDMode="Static" Style="text-align: left;" validation="Required" Enabled="false"></asp:TextBox>
                </div>
                <div class="label_plus_input par">
                    <span><%= WEB.NewBusiness.Common.Utility.Capitalize(RESOURCE.UnderWriting.NewBussiness.Resources.RNC) %></span>
                    <asp:TextBox runat="server" ID="txtRNC" ClientIDMode="Static" Style="text-align: left;" Enabled="false" RncNumber="RncNumber" validateLength="9,11" validation="Required"></asp:TextBox>
                </div>
                <div class="label_plus_input par">
