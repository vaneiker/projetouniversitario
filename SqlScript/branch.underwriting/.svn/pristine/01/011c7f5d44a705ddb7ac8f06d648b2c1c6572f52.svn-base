...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class SP_SET_UW_STEPS_EXTRA_INFO_Result
    {
        ...
        public Nullable<int> Step_Extra_Info_Type_Id { get; set; }
        public Nullable<int> Step_Extra_Info_Id { get; set; }
    }
}
