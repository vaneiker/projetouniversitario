<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCity.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCCity" %>



        <div class="tbl data_G mB">
         
               <asp:GridView ID="gvCity"
                runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvCity_PageIndexChanging">
                <Columns>

                    <asp:TemplateField HeaderText="City Name" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="c1" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="c1">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("City_Desc") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtNewCity', '#pnCity')" value="Add City">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnCity" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtNewCity" ClientIDMode="Static" runat="server" placeholder="Add City..." CssClass="row mB" />
