<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCPhoneNumber.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.WUCPhoneNumber" %>
...
<asp:UpdatePanel runat="server" ID="udpPhoneNumber" ClientIDMode="Static" UpdateMode="Conditional" OnUnload="UpdatePanel_Unload">
    <ContentTemplate>
        <asp:Panel runat="server" class="col-1-3" ID="frmPhoneNumbers" ClientIDMode="Static" Style="display: none">
            <div class="fondo_blanco">
                <div class="titulos_azules" id="titulos_azules"><span class="phone"></span><strong>
                    <asp:Literal runat="server" ID="ltPhoneNumbers">PHONE NUMBERS</asp:Literal></strong></div>
                <div class="content_fondo_blanco fix_height">
                    <asp:Panel runat="server" ID="pnForm" DefaultButton="btnAdd">
                        <div class="grupos">
                            <div style="width: 50%">
                                <label class="label red" runat="server" id="ltPhoneType">Phone Type</label>
                                <div class="wrap_select">
                                    <asp:DropDownList runat="server" ID="cbxPhoneType" validation='Required'>
                                    </asp:DropDownList>
                                </div>
                                <!--wrap_select-->
                            </div>
                            ...
                            <div class="float_right">
                                <div class="boton_wrapper amarillo float_right" id="dvAddBtn" runat="server">
                                    <span class="add"></span>
                                    <asp:Button runat="server" ID="btnAdd" Text="Add" CssClass="boton" AllowEnter="true" OnClientClick="return validateFormPhoneNumbers(this,'frmPhoneNumbers')" OnClick="btnAdd_Click" />
                                </div>
                                <!--boton_wrapper-->
                            </div>
                        </div>
                        ...
                        <div class="grupos de_4 small alingtoend">
                            ...
                            <div>
                                ...
                                <asp:TextBox ID="txtCountryCode" runat="server" AllowEnter="true" data-inputmask="'alias': 'integer','rightAlign': false,'clearMaskOnLostFocus': true,'allowMinus': false, 'allowPlus': false" ClientIDMode="Static" validation='Required' />
                            </div>
                            <div style="width=0;">
                    ...
                    <div class="grid_wrap margin_t_10 gris">
                         <dx:ASPxGridView ID="gvCommonPhone" runat="server"
                                KeyFieldName="DirectoryDetailId; DirectoryId"
                                EnableCallBacks="False"
                                AutoGenerateColumns="False"
                                SettingsPager-PageSize="15"
                                Width="100%" OnRowCommand="gvCommonPhone_RowCommand" OnPageIndexChanged="gvCommonPhone_PageIndexChanged" ClientIDMode="Static" OnPreRender="gvCommonPhone_PreRender">
        ...
        <asp:HiddenField ID="hdnTotalPhones" runat="server" Value="" ClientIDMode="Static" />
        <!--col-1-3-->
    </ContentTemplate>
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="gvCommonPhone" />
    </Triggers>
</asp:UpdatePanel>
