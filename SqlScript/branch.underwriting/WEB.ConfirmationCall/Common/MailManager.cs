...
namespace WEB.ConfirmationCall.Common
{
    public static class MailManager
    {
        ...
        public static void SendMessage(String to, String Copia, String BCC, String Body, String From, String Subject, List<AttachedFiles> Attachments, bool ishtml, string templatePath = "", string templateFinalPath = "", string areaLink = "")
        {
        ...
        /// <param name="Sender">Correo por el Cual Saldra el Mensaje</param>
        /// <param name="Header">Subject del Mensaje </param>
        public static void SendMessage(String to, String Copia, String BCC, String Body, String From, String Subject, string Attachments, bool ishtml, string templatePath = "", 
            string templateFinalPath = "", string areaLink = "", string paramOpcional="")
        {
