<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAttachment.ascx.cs" Inherits="WEB.ConfirmationCall.UserControls.History.UCAttachment" %>
...
<div class="grid_wrap margin_t_10">
    ...
    <dx:ASPxGridView EnablePagingGestures="False" ID="gvAttachedCalls" runat="server" ClientIDMode="Static"
        ...
        AutoGenerateColumns="False" KeyFieldName="RecordingFile; StepId; StepCaseNo"
        ...
        OnHtmlRowPrepared="gvAttachedCalls_HtmlRowPrepared" class="datagrid">
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn Caption="Play Recording" FieldName="PlayRecording" PropertiesEditType="TextBox">
                <DataItemTemplate>
    ...
    <asp:ObjectDataSource ID="dsCalls" runat="server" SelectMethod="GetCalls"
        TypeName="WEB.ConfirmationCall.UserControls.History.UCAttachment" OnSelecting="dsCalls_Selecting"></asp:ObjectDataSource>
</div>
<!--grid_wrap-->
...
<div class="grid_wrap margin_t_10">
    ...
    <asp:ObjectDataSource ID="dsDocuments" runat="server" SelectMethod="GetDocuments"
        TypeName="WEB.ConfirmationCall.UserControls.History.UCAttachment" OnSelecting="dsDocuments_Selecting"></asp:ObjectDataSource>
    <!--grid_wrap-->
</div>
<asp:ModalPopupExtender ID="ModalPopupPadecimiento" BackgroundCssClass="modalPopup" PopupControlID="pnPadecimiento" TargetControlID="hfPadecimiento" BehaviorID="popupPadecimiento" runat="server">
