<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPolicyDetails.ascx.cs" Inherits="WEB.ConfirmationCall.UserControls.ConfirmationCall.UCPolicyDetails" %>
    ...
    <ul class="principal" id="acc2">
        <li>
            <a href="#item1" id="current">
                ...
                <%= RESOURCE.UnderWriting.ConfirmationCall.Resources.GeneralInformation.ToUpper() %> <span>
                    <!--icono-->
                </span>
            </a>
            <ul>
                            ...
                            <div class="g_information">
                                    ...
                                    <div id="TabbedPanels2" class="TabbedPanels">
                                        <ul class="TabbedPanelsTabGroup bdr0">
                                            <div class="con_previewBTN2">
                                                <asp:Button ID="UCPersonalDataPreviewBtn" CssClass="previewBTN" runat="server" Text="" OnClick="UCPersonalDataPreviewBtn_Click" />
                                            </div>
                                        </ul>
                                ...
                                <div>
                                    <div class="grupos de_2">
                                        <div>
                                            <label class="label"><%= RESOURCE.UnderWriting.ConfirmationCall.Resources.OwnerName %></label>
        ...
        <li>
            <a href="#item3" id="">
                ...
                <%= RESOURCE.UnderWriting.ConfirmationCall.Resources.AmountPeriods.ToUpper()  %>
                <span>
                    <!--icono-->
                </span>
            </a>
                    ...
                    <div class="fondo_blanco">
                        <div class="content_fondo_blanco bg_gris">
                            ...
                            <asp:ObjectDataSource ID="dsAmountsAndPeriods" runat="server" SelectMethod="GetAmountsAndPeriods"
                                TypeName="WEB.ConfirmationCall.UserControls.ConfirmationCall.UCPolicyDetails" OnSelecting="dsAmountsAndPeriods_Selecting"></asp:ObjectDataSource>
                            <!--grid_wrap-->
                                        ...
                                        <asp:Repeater runat="server" ID="gvRiders">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="c2">
                                                        <div><%#Eval("BeneficiaryAmount", "{0:$#,##0.00}")%></div>
                                                    </td>
                                                    <td class="c3">
                        ...
                        <div class="content_fondo_blanco bg_gris">
                            <dx:ASPxGridView runat="server" ID="gvBeneficiaries">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="PERCENTAGE" FieldName="BenefitsPercent">
                                    ...
                                    <dx:GridViewDataColumn Caption="BIRTHDATE" FieldName="Dob"></dx:GridViewDataColumn>
                                </Columns>
                                <SettingsPager AlwaysShowPager="true" PageSize="4" NumericButtonCount="3" />
                                <SettingsLoadingPanel Mode="Disabled" />
                                <SettingsPopup>
        ...
        <li>
            <a href="#item7" id="">
                ...
                <%= RESOURCE.UnderWriting.ConfirmationCall.Resources.OtherProducts.ToUpper()%><span><!--icono--></span>
            </a>
            <ul>
                <li>
                    <div class="fondo_blanco">
                            ...
                            <div class="grid_wrap">
                                <dx:ASPxGridView EnablePagingGestures="False" ID="grdOtherProduct" runat="server" ClientIDMode="Static"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataColumn Caption="Roles" FieldName="RoleDesc">
                                            <HeaderStyle CssClass="c5"></HeaderStyle>
                                        </dx:GridViewDataColumn>
                                    </Columns>
                                    <SettingsPager AlwaysShowPager="true" PageSize="4" NumericButtonCount="3" />
                                ...
                                <asp:ObjectDataSource ID="dsOtherProduct" runat="server" SelectMethod="GetOtherProduct"
                                    TypeName="WEB.ConfirmationCall.UserControls.ConfirmationCall.UCPolicyDetails" OnSelecting="dsOtherProduct_Selecting"></asp:ObjectDataSource>
                            </div>
                            <!--grid_wrap-->
