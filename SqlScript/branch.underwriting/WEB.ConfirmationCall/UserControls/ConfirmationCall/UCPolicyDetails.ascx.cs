...
namespace WEB.ConfirmationCall.UserControls.ConfirmationCall
{
    public partial class UCPolicyDetails : UC
    {
        ...
        void Translate()
        {
            ...
            //
            GrdAmountsAndPeriods.SettingsText.EmptyDataRow = RESOURCE.UnderWriting.ConfirmationCall.Resources.RowEmpty;
            gvBeneficiaries.SettingsText.EmptyDataRow = RESOURCE.UnderWriting.ConfirmationCall.Resources.RowEmpty;
            grdOtherProduct.SettingsText.EmptyDataRow = RESOURCE.UnderWriting.ConfirmationCall.Resources.RowEmpty;

            UCPersonalDataPreviewBtn.Text = RESOURCE.UnderWriting.ConfirmationCall.Resources.Preview;
        ...
        //LLENA INFORMATION PERSONAL
        void llenaPoliciesPersonal()
        {

            string parameter = string.Format("Corp_Id:{0},Region_Id:{1},Country_Id:{2},Domesticreg_Id:{3},State_Prov_Id:{4},City_Id:{5},Office_Id:{6},Case_Seq_No:{7},Hist_Seq_No:{8}", _services.Corp_Id, _services.Region_Id, _services.Country_Id, _services.Domesticreg_Id,
            ...
            try
            {
                ...
                //ToTitleCase(lstPolicies.PolicyStatus);
                ...
                tbPolicyStatus.Text = ResourcesProvider.GetString(System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(lstPolicies.PolicyStatus.ToLower()));
            ...
            catch (Exception ex)
            {
                ...
                ConfirmationCallLog.Log("llenaPoliciesPersonal", string.Format("Message: {0}, StackTrace: {1} ", ex.Message,ex.StackTrace), parameter, 
        ...
        void FillBeneficiarios()
        {
            ...
            var isInsured = true;
            List<Beneficiary> lista = null;
            lista = new List<Beneficiary>();

            lista = _services.oBeneficiaryManager.GetAllBeneficiary(_services.Corp_Id, _services.Region_Id, _services.Country_Id, _services.Domesticreg_Id,
                _services.State_Prov_Id, _services.City_Id, _services.Office_Id, _services.Case_Seq_No, _services.Hist_Seq_No, isInsured,
                1, null, UserDataProvider.LanguageId).ToList();
            lista.AddRange(_services.oBeneficiaryManager.GetAllBeneficiary(_services.Corp_Id, _services.Region_Id, _services.Country_Id,
                _services.Domesticreg_Id, _services.State_Prov_Id, _services.City_Id, _services.Office_Id,
                _services.Case_Seq_No, _services.Hist_Seq_No, isInsured, 2, null, UserDataProvider.LanguageId).ToList());
        ...
        {           
            ...
            gvRiders.DataSource = _services.oRiderManager.GetAllRider(new Policy.Parameter()
            {
