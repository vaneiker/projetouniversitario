<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCHeader.ascx.cs" Inherits="WEB.ConfirmationCall.UserControls.Common.UCHeader" %>
...
<div class="col-1-1">
    <div id="contenedor_tabshistory" runat="server" class="contenedor_tabs Display">
        <ul class="tabs_ttle dvddo_in_4" id="MenuHeader">
            <li class="active">
                <asp:LinkButton ID="btnAll" runat="server" OnClick="btnSelectTAB_Click" OnClientClick="javascript:__doPostBack('ctl00$bodyContent$UCHeader$btnAll','')" CommandName="btnAll" ClientIDMode="Static"> <%= RESOURCE.UnderWriting.ConfirmationCall.Resources.ALL.ToUpper() %></asp:LinkButton>
                <i class="punt" id="iliAll" runat="server">34</i>

            </li>
            <li>
                <asp:LinkButton ID="btnPending" runat="server" OnClick="btnSelectTAB_Click" OnClientClick="javascript:__doPostBack('ctl00$bodyContent$UCHeader$btnPending','')" CommandName="btnPending" ClientIDMode="Static"><%= RESOURCE.UnderWriting.ConfirmationCall.Resources.Pending.ToUpper() %></asp:LinkButton>
                <i class="punt" id="iliPending" runat="server">04</i></li>
            <li>
                <asp:LinkButton ID="btnMedical" runat="server" OnClick="btnSelectTAB_Click" OnClientClick="javascript:__doPostBack('ctl00$bodyContent$UCHeader$btnMedical','')" CommandName="btnMedical" ClientIDMode="Static"><%= RESOURCE.UnderWriting.ConfirmationCall.Resources.Medical.ToUpper() %></asp:LinkButton>
                <i class="punt" id="iliMedical" runat="server">12</i></li>
            <li>
                <asp:LinkButton ID="btnComplete" runat="server" OnClick="btnSelectTAB_Click" OnClientClick="javascript:__doPostBack('ctl00$bodyContent$UCHeader$btnComplete','')" CommandName="btnComplete" ClientIDMode="Static"><%= RESOURCE.UnderWriting.ConfirmationCall.Resources.Complete.ToUpper() %></asp:LinkButton>
                <i class="punt" id="iliComplete" runat="server">10</i></li>
            <li>
                <asp:LinkButton ID="btnWarning" runat="server" OnClick="btnSelectTAB_Click" OnClientClick="javascript:__doPostBack('ctl00$bodyContent$UCHeader$btnWarning','')" CommandName="btnWarning" ClientIDMode="Static"><%= RESOURCE.UnderWriting.ConfirmationCall.Resources.Warning.ToUpper() %></asp:LinkButton>
    ...
    <div class="grid_wrap">
      ...
      <%--          <dx:GridViewDataTextColumn Caption="INITIAL DATE" FieldName="InitialDate" UnboundType="DateTime" PropertiesTextEdit-DisplayFormatString="g">
        ...
        <asp:ObjectDataSource ID="dsConfirmationCall" runat="server" SelectMethod="GetConfirmationCall"
            TypeName="WEB.ConfirmationCall.UserControls.Common.UCHeader" OnSelecting="dsConfirmationCall_Selecting"></asp:ObjectDataSource>
    </div>
    <!--grid_wrap-->
</div>
<!--col-1-1-->
