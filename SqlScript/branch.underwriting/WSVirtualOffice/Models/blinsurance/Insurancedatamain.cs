...
namespace WSVirtualOffice.Models.blinsurance
{
    struct Insurancedatamain
    {
        ...
        public static Illusresult getInsuredamount(double mininsuredamount, double maxinsuredamount, double targetaccountvalue, double precision, Accountvaluedata[] acvaluedata, Productinvprofile prodprofile)
        {
            ...
            Growthcase[] g1 = calculategeneralaccountvalue(tempaccountvaluedata, maindata);
            ...
            //MessageBox.Show(tempaccountvaluedata[0].netgrowthrate.ToString() + "," + acvaluedata[0].netgrowthrate.ToString());
            Growthcase[] g2 = calculategeneralaccountvalue(tempaccountvaluedata, maindata);
            ...
            //MessageBox.Show(tempaccountvaluedata[0].netgrowthrate.ToString() + "," + acvaluedata[0].netgrowthrate.ToString());
            Growthcase[] g3 = calculategeneralaccountvalue(tempaccountvaluedata, maindata);
        ...
        private static Mainvaluedata calculateaccountvalue(double insuredamount, Accountvaluedata[] acvaluedata, Productinvprofile prodprofile)
        {
            ...
            for (int i = 0; i < acvaluedata.Length; i++)
            {
                ...
                double costofinsurance = (insuredamount - accountvalue) * (1 / 1000.0) * (((acvaluedata[i].mortalityrate * (1 + acvaluedata[i].activityrisk)) * (1 + acvaluedata[i].targetoverage)) + acvaluedata[i].illnessrisk);
        ...
        private static Mainvaluedata calculateaccountvaluepremium(double premiumamount, Accountvaluedata[] acvaluedata, int contributionperiod, Productinvprofile prodprofile)
        {
            ...
            if (premiumamount <= 2000 && premiumamount >= 1000)
            {
                int l = 0;
            }
            ...
            for (int i = 0; i < acvaluedata.Length; i++)
            {
                ...
                double costofinsurance = (acvaluedata[i].insuredamount - accountvalue) * (1 / 1000.0) * (((acvaluedata[i].mortalityrate * (1 + acvaluedata[i].activityrisk)) * (1 + acvaluedata[i].targetoverage)) + acvaluedata[i].illnessrisk);
        ...
        private static Growthcase[] calculategeneralaccountvalue(Accountvaluedata[] acvaluedata, Mainvaluedata maindata)
        {
            double accountvalue = 0.0;
