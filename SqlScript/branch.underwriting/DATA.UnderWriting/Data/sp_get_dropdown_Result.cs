...
namespace DATA.UnderWriting.Data
{
    ...
    public partial class sp_get_dropdown_Result
    {
        ...
        public Nullable<decimal> activityriskvalue { get; set; }
        public string healthrisktype { get; set; }
        public Nullable<int> healthrisktypeno { get; set; }
        public Nullable<decimal> healthriskvalue { get; set; }
        ...
        public Nullable<decimal> investmentprofilerate { get; set; }
        ...
        public Nullable<decimal> riskvalue { get; set; }
        ...
        public Nullable<int> mortalityno { get; set; }
        public Nullable<int> age { get; set; }
        public Nullable<decimal> malenonsmoker { get; set; }
        public Nullable<decimal> femalenonsmoker { get; set; }
        public Nullable<decimal> malesmoker { get; set; }
        public Nullable<decimal> femalesmoker { get; set; }
        public string ridertypecode { get; set; }
        public Nullable<int> yearno { get; set; }
        public Nullable<decimal> vr { get; set; }
        public Nullable<decimal> additionalpenalty { get; set; }
        public Nullable<decimal> regularcomm { get; set; }
        public Nullable<decimal> excesscomm { get; set; }
        public Nullable<int> commissionno { get; set; }
        public Nullable<decimal> penaltypercent { get; set; }
        public Nullable<int> surrenderpenaltyno { get; set; }
