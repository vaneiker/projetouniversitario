...
namespace WEB.NewBusiness.Common.Illustration.BusinessLogic
{
    public class IAccountvalue
    {
        ...
        public static IResultData calculateInsuredamount(IMainInsuranceData insmaindata, IAssumeddata asdata, RulesService rulesService)
        {
            ...
            {
                numexecutiontimes = 0;
                double gsmaxadbcost = rulesService.GetValue(RulesService.Rules.GS_MAXIMUM_ADB_COST);
            ...
            {
                numexecutiontimes = 0;
                double gsmaxtermcost = rulesService.GetValue(RulesService.Rules.GS_MAXIMUM_TERM_COST);
            ...
            {
                numexecutiontimes = 0;
                double gsmaxoircost = rulesService.GetValue(RulesService.Rules.GS_MAXIMUM_OIR_COST);
        ...
        public static IResultData calculatePremiumamount(IMainInsuranceData insmaindata, IAssumeddata asdata, RulesService rulesService)
        {
            IResultData resdata1 = new IResultData();
            IResultData resdata = null;
            /*
        ...
        public static IResultData calculateNinguna(IMainInsuranceData insmaindata, IAssumeddata asdata, RulesService rulesService)
        {
            IResultData resdata1 = new IResultData();
