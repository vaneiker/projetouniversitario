...
{
    class THSecurityAssertion : SecurityPolicyAssertion
    {
        private string m_username;
        private string m_password;
        private X509Certificate2 m_certificate;

        public THSecurityAssertion(string user, string password)
            : this(user, password, null)
        {
        }

        public THSecurityAssertion(string user, string password, string certificateLocation)
        {
            m_username = user;
            m_password = password;
        ...
        {
            return new THSecurityClientOutputFilter(this);
        }
    ...
    class THSecurityClientOutputFilter : SendSecurityFilter
    {
        private THSecurityAssertion m_parentAssertion;

        public THSecurityClientOutputFilter(THSecurityAssertion parentAssertion)
