<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAirPlane.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.IllustrationAlliedLines.Products.UCAirPlane" %>
<%@ Register Assembly="DevExpress.Web.v14.2, Version=14.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/NewBusiness/UserControls/IllustrationAlliedLines/UCAirPlaneDetail.ascx" TagPrefix="uc1" TagName="UCAirPlaneDetail" %>
...
<dx:ASPxGridView
    ...
    KeyFieldName="UniqueAirplaneId;InsuredAmount"
    ClientIDMode="Static"
    AutoGenerateColumns="false"
    Width="100%"
    OnRowCommand="gvAlliedLinesDetail_RowCommand"
    OnPreRender="gvAirPlaneDetail_PreRender">
    <Columns>
                    ...
                    <ContentTemplate>
                        <div style="text-align: center">
                            <asp:LinkButton
                                runat="server"
                                ID="lnkEdit"
                                CommandName="EditAirPlane" CssClass="view_file">
                            </asp:LinkButton>
                        </div>
                    </ContentTemplate>
                    <Triggers>
        ...
        <dx:GridViewDataTextColumn Caption="BrandModelLabel" FieldName="BrandModel" Name="BrandModelLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="1">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="YearFabricationCascoLabel" FieldName="Year" Name="YearFabricationCascoLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="2">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="SerialKey" FieldName="SerialKey" Name="SerialKey" CellStyle-HorizontalAlign="Center" VisibleIndex="3">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="PlateAirplane" FieldName="Name" Name="PlateAirplane" CellStyle-HorizontalAlign="Center" VisibleIndex="4">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataColumn Caption="New" Name="New" Width="100" Visible="false" VisibleIndex="5">
            <DataItemTemplate>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div style="text-align: center">
        ...
        <dx:GridViewDataTextColumn Caption="AirplaneBase" FieldName="AirplaneBase" Name="AirplaneBaseLabel" CellStyle-HorizontalAlign="Center" VisibleIndex="6">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="AircraftValue" FieldName="InsuredAmountF" Name="AircraftValue" CellStyle-HorizontalAlign="Center" VisibleIndex="7">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="pól. Princ." FieldName="PolicyNoMain" Name="PolicyNumberMain" Visible="false" CellStyle-HorizontalAlign="Center" VisibleIndex="8">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn Caption="Deducible" FieldName="DeductiblePercentageF" Name="Deductible" CellStyle-HorizontalAlign="Center" VisibleIndex="11">
            <Settings AllowHeaderFilter="False" AllowSort="False" />
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataColumn Caption="Cobertura" Name="Coverage" Width="100" HeaderStyle-CssClass="customized" VisibleIndex="13">
            <DataItemTemplate>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div style="text-align: center">
        ...
        <dx:GridViewDataColumn Caption="Endoso" Name="Endorsement" Width="100" HeaderStyle-CssClass="customized" VisibleIndex="14">
            <DataItemTemplate>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div style="text-align: center">
...
<asp:ModalPopupExtender ID="ModalPopupCoverage" PopupControlID="popCoverage" DropShadow="false" BackgroundCssClass="ModalBackgroud3" TargetControlID="hdnAirCoverages" BehaviorID="airupBhvrairCoverages" runat="server"></asp:ModalPopupExtender>
<asp:Panel runat="server" ID="popCoverage" ClientIDMode="Static" Style="display: none;">
    <div class="pop_up_wrapper" style="width: 936px; height: 775px; overflow-x: hidden; overflow-y: hidden">
        ...
        <div class="titulos_azules head_contengridproxi PreviewPDF" style="width: 100%;">
            <ul>
                ...
                <li style="top: 13%;">
                    <input type="button" id="close_pop_up" class="cls_pup" style="background-color: transparent; border: none;" onclick="CloseAirCoverage();" />
                </li>
            </ul>
        </div>
...
<asp:ModalPopupExtender ID="mpeAirPlaneDetail" PopupControlID="pnAirPlaneDetail" DropShadow="false" BackgroundCssClass="ModalBackgroud3" TargetControlID="hdnPopAirPlaneDetail" BehaviorID="popupBhvrAirPlaneDetail" runat="server"></asp:ModalPopupExtender>
<asp:Panel runat="server" ID="pnAirPlaneDetail" CssClass="modalPopup" ClientIDMode="Static" Style="display: none">
    <div class="pop_up_wrapper" style="width: 1529px; height: 860px; overflow-x: hidden; overflow-y: hidden">
        <!--escriben por style el ancho que desean-->
        <div class="titulos_azules head_contengridproxi PreviewPDF" style="width: 100%;">
            <ul>
                <li style="position: absolute; left: 41%; top: 31%;">
                ...
                <li style="top: 13%;">
                    <input type="button" id="close_pop_up" class="cls_pup" style="background-color: transparent; border: none;" onclick="ClosePopAirPlaneDetail();" />
                </li>
            </ul>
        </div>
        <!--titulos_azules-->
        <uc1:UCAirPlaneDetail runat="server" ID="UCAirPlaneDetail" />
        <!--content_fondo_blanco-->
    </div>
</asp:Panel>
...
<asp:HiddenField runat="server" ID="hdnAirCoverages" Value="false" ClientIDMode="Static" />
<asp:HiddenField runat="server" ID="hdnPopAirPlaneDetail" Value="false" ClientIDMode="Static" />
