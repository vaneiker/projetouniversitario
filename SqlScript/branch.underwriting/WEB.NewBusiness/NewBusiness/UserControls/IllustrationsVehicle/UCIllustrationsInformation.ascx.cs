...
{
    public partial class UCIllustrationsInformation : UC, IUC
    {
        ...
        public void FillData()
        {
            ...
            var Illustrations = ObjServices.oPolicyManager.GetQuotationInfoTemp(new Policy.Quo.Temp
            {
                ContactId = ObjServices.ContactEntityID.GetValueOrDefault(),
                PolicyNo = policy.PolicyNo
            })
            .OrderBy(o => o.PolicyNo)
            .ThenBy(o => o.QuoDate)
            .Where(o => !(
            ...
            .Select(o => new
            {
                ...
                CreateDate = o.QuoDate.ToString("dd-MMM-yyyy", CultureInfo.InvariantCulture).ToUpper(),
            ...
            gvIllustrations.DataSource = Illustrations;
            gvIllustrations.DataBind();
        }
        ...
        protected void gvIllustrations_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
        ...
        protected void gvIllustrations_PreRender(object sender, EventArgs e)
        {
            (sender as DevExpress.Web.ASPxGridView).TranslateColumnsAspxGrid();
        }

        protected void gvIllustrations_PageIndexChanged(object sender, EventArgs e)
        {
            FillData();
        }
    }
