<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSentinel.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.Illustration.PlanInformation.UCSentinel" %>
<ul>
    <li>
