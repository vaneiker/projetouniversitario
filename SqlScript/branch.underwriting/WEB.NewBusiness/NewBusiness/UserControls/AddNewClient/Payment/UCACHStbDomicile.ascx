<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCACHStbDomicile.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCACHStbDomicile" %>
<div class="content_fondo_blanco" id="frmPay">
    ...
    <div class="grupos de_2">
        ...
        <div>
            ...
            <asp:TextBox ID="txtBankName" runat="server" validation="Required" Enabled="true"></asp:TextBox>
        </div>
        <div>
