<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContainerCCOneTime.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCContainerCCOneTime" %>
...
<div class="content_fondo_blanco" id="frmPay">
    ...
    <div class="grupos de_2">
        ...
        <div style="display:none">
            ...
            <asp:TextBox ID="txtRepeatCardNumber" runat="server"  data-inputmask="'mask': '9999-9999-9999-9999'" creditcard="creditcard" ClientIDMode="Static"></asp:TextBox>

        </div>
        <div style="display:none">
            <label class="label" runat="server" id="CIDorCVVN2">CID or CVV #2</label>
            <asp:TextBox ID="txtCIDCVV" runat="server"></asp:TextBox>
        </div>
        <div style="display:none">
