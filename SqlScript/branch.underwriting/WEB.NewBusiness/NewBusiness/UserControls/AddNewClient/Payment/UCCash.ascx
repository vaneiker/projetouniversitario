<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCash.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.Payment.UCCash" %>
<div class="content_fondo_blanco" id="frmPay">
    ...
    <div class="grupos de_2">
        ...
        <div>
            <label class="label red" runat="server" id="Name">Name</label>
		...
		<!--Bmarroquin 20-02-2017 cambios a raiz de tropicalizacion en ESA, a solicitud de Negocio este dato Si es requerido para este medio de pago-->
        <div>
