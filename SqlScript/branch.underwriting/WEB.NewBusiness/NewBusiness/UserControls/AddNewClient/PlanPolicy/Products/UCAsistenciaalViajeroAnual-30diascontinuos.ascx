<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAsistenciaalViajeroAnual-30diascontinuos.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.UCAsistenciaalViajeroAnual_30diascontinuos" %>
                               <div class="col-1-4-c">
