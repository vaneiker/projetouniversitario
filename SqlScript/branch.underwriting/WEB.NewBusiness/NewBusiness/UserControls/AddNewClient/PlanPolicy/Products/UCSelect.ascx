<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSelect.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.UCSelect" %>
<div class="col-1-4-c">
        ...
        <asp:Panel runat="server" ClientIDMode="Static" class="content_fondo_blanco" ID="frmPlan">
            ...
            <fieldset class="margin_t_10">
                ...
                <div class="grupos de_2">
                    ...
                    <div>
                        <label class="label" runat="server" id="OrganTransplant">Organ Transplant</label>
                        <div class="wrap_select">
                            <asp:DropDownList ID="ddlOrganTransplant" runat="server" OnPreRender="TranslateDrop_PreRender">
                                <asp:ListItem Text="NO" Value="2"></asp:ListItem>
                                <asp:ListItem Text="YES" Value="1"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
