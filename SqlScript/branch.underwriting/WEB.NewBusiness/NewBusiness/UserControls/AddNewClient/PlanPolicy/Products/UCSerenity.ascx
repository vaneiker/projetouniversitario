<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSerenity.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.UCSerenity" %>
                                          <div class="col-1-4-c">
