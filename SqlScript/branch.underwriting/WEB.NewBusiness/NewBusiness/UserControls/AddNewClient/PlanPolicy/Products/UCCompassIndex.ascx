<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCompassIndex.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.UCCompassIndex" %>
<div class="col-1-4-c">
        ...
        <asp:Panel runat="server" ClientIDMode="Static" class="content_fondo_blanco" ID="frmPlan">
            <div class="grupos de_3">
                <div>
                    ...
                    <div class="wrap_select">
                        <asp:DropDownList ID="ddlFamilyProduct" runat="server" AutoPostBack="true"  validation="Required">
                        </asp:DropDownList>
                    </div>
                    <!--wrap_select-->
                </div>
                ...
                <asp:panel runat="server" ID="pnPlanType" style="display:none">
            ...
            <div class="grupos de_2">
                <div>
                    ...
                    <div class="wrap_select">
                        <asp:DropDownList ID="ddlInitialContribution" runat="server" AutoPostBack="true" validation="Required" OnPreRender="TranslateDrop_PreRender">
...
<%--                <div>
                ...
                <div>
                    ...
                    <asp:TextBox ID="txtAmount2" runat="server" ClientIDMode="Static" decimal="decimal"></asp:TextBox>
                </div>
                <div>
                    <label class="label" runat="server" id="AtAgeGoal">At Age Goal</label>
                    <asp:TextBox ID="txtAtAge" ClientIDMode="Static" runat="server" number="number"></asp:TextBox>
                </div>
            </div>
            <!--grupos-->
            <fieldset class="margin_t_10">
                ...
                <div class="grupos de_1">
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtSpouseOtherInsured" runat="server" decimal="decimal"></asp:TextBox>
                    </div>
                    <div>
                        <label class="label" runat="server" id="YearsspouseOther" >Years</label>
                        <asp:TextBox ID="txtYearsSpouseOther" runat="server" number="number2"></asp:TextBox>
                    </div>
                ...
                <div class="grupos de_2">
                   <%-- <div>
                        ...
                        <div class="wrap_select">
                            <asp:DropDownList ID="ddlCritialIllness" runat="server" AutoPostBack="true" Visible="false">
