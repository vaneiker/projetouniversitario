<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCFortis.ascx.cs" Inherits="WEB.NewBusiness.NewBusiness.UserControls.AddNewClient.PlanPolicy.Products.UCFortis" %>
<div class="col-1-4-c">
    <div class="fondo_blanco fix_height">
        ...
        <asp:Panel runat="server" ClientIDMode="Static" class="content_fondo_blanco" ID="frmPlan">
            ...
            <div class="grupos de_4">
                  <div>
                    <label class="label red" runat="server" id="lblDeducibleType">Deducible Type</label>                      
                    <div class="wrap_select">
                        <asp:DropDownList ID="ddlDeducibleType" runat="server" validation="Required" AutoPostBack="True">                            
                        </asp:DropDownList>
                    </div>
                    <!--wrap_select-->
                </div>
                <div>
                    ...
                    <div class="wrap_select">
                        <asp:DropDownList ID="ddlDeducible" ClientIDMode="Static" runat="server" validation="Required" Enabled="False">                            
                        </asp:DropDownList>
                    </div>
                    <!--wrap_select-->
                </div>
            ...
            <div class="grupos de_2">
                <div>
                    <label class="label" runat="server" id="DepositAmount">Initial Payment</label>
                    <div class="wrap_select">
            ...
            <fieldset class="margin_t_10">
                ...
                <div class="grupos de_2">
                    ...
                    <div>
                        <label class="label" runat="server" id="MaternityAndNewBornComplication">Maternity and Newborn Complication</label>
                        <div class="wrap_select">
                            <asp:DropDownList ID="ddlMaternityAndNewBornComplication" runat="server" OnPreRender="TranslateDrop_PreRender">
                                <asp:ListItem Text="NO" Value="2"></asp:ListItem>
                                <asp:ListItem Text="YES" Value="1"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
