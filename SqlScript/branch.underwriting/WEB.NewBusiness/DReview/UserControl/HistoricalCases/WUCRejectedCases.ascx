<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCRejectedCases.ascx.cs" Inherits="WEB.NewBusiness.DReview.UserControl.HistoricalCases.WUCRejectedCases" %>
...
<asp:UpdatePanel runat="server" ID="udpApprovedCases">
    <ContentTemplate>
        <dx:ASPxGridView ID="gvRejectedCases"
            ...
            runat="server" ClientIDMode="Static" DataSourceID="LinqDS" EnableCallBacks="False" Width="100%" AutoGenerateColumns="false" OnRowCommand="gvRejectedCases_RowCommand" OnPreRender="gvRejectedCases_PreRender">
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn FieldName="ChangeDate" Caption="REJECTED DATE" Name="REJECTEDDATE" />
    ...
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="gvRejectedCases" />
    </Triggers>
</asp:UpdatePanel>
