    ...
    $.sliderTabs = function (container, options) {
        ...
        plugin.init = function () {
            ...
            $tabsListWrapper.resize(function () {
                ...
                $tabsList.children().each(function (index) {
                    totalWidth += parseInt($(this).width() + 5, 10);
                });

                $tabsList.width(totalWidth);
            ...
            $('.accordion_tabulado ul:first-child li a').on('click', function () {
        ...
        var resizeContentContainer = function (target) {
            ...
            var width = 0; //$tabsList.width($tabsList.parent().width());
            ...
            $("#mySliderTabs ul li").each(function (index) {
                totalWidth += parseInt($(this).width() + 5, 10);
            });
        ...
        var resizeTabsList = function () {
            ...
            $tabsList.width(totalWidth);
            //$tabsList.width($tabsList.parent().width() + 70);
