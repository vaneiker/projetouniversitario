...
namespace ThunderheadWrap
{
    ...
    public class Service
    {
        public enum TemplateType
        {
            ...
            ContratoKSI,
            FacturaSysFlex,
            EndosoAclaratorioDepreciacionMinPT,
            EnsosoAclaratorioAplicacionDeducible,
            EnsosoAclaratorioEconoVida
        }
        ...
        private void SetParametersAlliedLines(TemplateType templateType, ContactCountry CountryCode = ContactCountry.RepublicaDominicana)
        {
            ...
            try
            {
                if (templateType == TemplateType.CondicionesParticulares)
                {
                    batchConfigProperty = int.Parse(System.Configuration.ConfigurationManager.AppSettings["batchConfigCondicionesParticularesLineasAliadas"]);
                    projectIDProperty = int.Parse(System.Configuration.ConfigurationManager.AppSettings["projectIDCondicionesParticularesLineasAliadas"]);
                }
        ...
        private void SetParametersAuto(TemplateType templateType)
        {
            try
            {
                ...
                var vbatchConfigCondicionadoAutoVO = int.Parse(System.Configuration.ConfigurationManager.AppSettings["batchConfigCondicionadoVO"]);
                var vprojectIDCondicionadoAutoVO = int.Parse(System.Configuration.ConfigurationManager.AppSettings["projectIDCondicionadoAutoVO"]);
                var vbatchConfigSysFlexInvoice = int.Parse(System.Configuration.ConfigurationManager.AppSettings["batchConfigSysFlexInvoice"]);
                var vprojectIDSysFlexInvoice = int.Parse(System.Configuration.ConfigurationManager.AppSettings["projectIDSysFlexInvoice"]);
                ...
                switch (templateType)
                {
                    ...
                    case TemplateType.EndosoAclaratorioDepreciacionMinPT:
                    case TemplateType.EnsosoAclaratorioAplicacionDeducible:
                    case TemplateType.EnsosoAclaratorioEconoVida:
                        vbatchConfigResID = vbatchConfigResIDQuot;
                        vprojectID = vprojectIDQuot;
                        break;
                    ...
                    case TemplateType.Condicionado:
                        vbatchConfigResID = vbatchConfigCondicionadoAutoVO;
                        vprojectID = vprojectIDCondicionadoAutoVO;
                        break;
                    case TemplateType.FacturaSysFlex:
                        vbatchConfigResID = vbatchConfigSysFlexInvoice;
                        vprojectID = vprojectIDSysFlexInvoice;
                        break;
                }
