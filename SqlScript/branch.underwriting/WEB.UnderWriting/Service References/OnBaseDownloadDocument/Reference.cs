...
namespace WEB.UnderWriting.OnBaseDownloadDocument {
    ...
    public interface HylandOutBoundContract {
        ...
        WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesOutput Get_document_data(WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesInput DocumentData);
        
        [System.ServiceModel.OperationContractAttribute(Action="WebServicePublishing/DocData/DocumentData/Get_document_data", ReplyAction="WebServicePublishing/DocData/DocumentData/Get_document_data/response")]
        System.Threading.Tasks.Task<WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesOutput> Get_document_dataAsync(WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesInput DocumentData);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface HylandOutBoundContractChannel : WEB.UnderWriting.OnBaseDownloadDocument.HylandOutBoundContract, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HylandOutBoundContractClient : System.ServiceModel.ClientBase<WEB.UnderWriting.OnBaseDownloadDocument.HylandOutBoundContract>, WEB.UnderWriting.OnBaseDownloadDocument.HylandOutBoundContract {
        ...
        public WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesOutput Get_document_data(WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesInput DocumentData) {
            return base.Channel.Get_document_data(DocumentData);
        }
        
        public System.Threading.Tasks.Task<WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesOutput> Get_document_dataAsync(WEB.UnderWriting.OnBaseDownloadDocument.DocumentBytesInput DocumentData) {
