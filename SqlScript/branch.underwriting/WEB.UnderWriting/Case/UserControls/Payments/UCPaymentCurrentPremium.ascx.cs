...
{
	public partial class UCPaymentCurrentPremium : System.Web.UI.UserControl
	{
		...
		{
			var data = new System.Data.DataTable("CurrentPremium");
			...
			gvCurrentPremium.DataSource = data;
			gvCurrentPremium.DataBind();

			setPagerIndex(gvCurrentPremium);

			if (gvCurrentPremium.BottomPagerRow != null)
			{
				var totalItems = (Literal)gvCurrentPremium.BottomPagerRow.FindControl("totalItems");
