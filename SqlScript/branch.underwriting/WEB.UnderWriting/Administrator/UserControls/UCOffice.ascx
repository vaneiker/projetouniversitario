<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCOffice.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCOffice" %>

        <div class="tbl data_G mB">
         
               <asp:GridView ID="gvOffice"
                runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvOffice_PageIndexChanging">
                <Columns>

                    <asp:TemplateField HeaderText="Office Name" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="c1" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="c1">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Office_Desc") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
       ...
       <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtNewOffice', '#pnOffice')" value="Add Office">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnOffice" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtNewOffice" ClientIDMode="Static" runat="server" placeholder="Add Office..." CssClass="row mB" />
