<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRegion.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCRegion" %>
 ...
 <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtNewRegion', '#pnRegion')" value="Add Region">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnRegion" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtNewRegion" ClientIDMode="Static" runat="server" placeholder="Add Region..." CssClass="row mB" />
