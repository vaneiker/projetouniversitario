<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCState.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCState" %>


        <div class="tbl data_G mB">
         
               <asp:GridView ID="gvState"
                runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvState_PageIndexChanging">
                <Columns>

                    <asp:TemplateField HeaderText="State Name" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="c1" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="c1">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("State_Desc") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtNewState', '#pnState')" value="Add State">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnState" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtNewState" ClientIDMode="Static" runat="server" placeholder="Add State..." CssClass="row mB" />
