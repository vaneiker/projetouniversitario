<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRegionCountry.ascx.cs" Inherits="WEB.UnderWriting.Administrator.UserControls.UCRegionCountry" %>



        <div class="tbl data_G mB">
         
               <asp:GridView ID="gvRegion"
                runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvRegion_PageIndexChanging">
                <Columns>

                    <asp:TemplateField HeaderText="Region Name" HeaderStyle-HorizontalAlign="center" HeaderStyle-CssClass="c1" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="c1">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Region_Desc") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
 ...
 <div class="wd100 fl hg35 mB">
                    ...
                    <div class="boton_wrapper gradient_AM_btn bdrAM txtNG-f fl">
                        <span class="add"></span>
                        <input class="boton" type="button" onclick="TogglePanel('#txtRegionCountry', '#pnRegionCountry')" value="Add Region">
                    </div>
                </div>


                <asp:Panel runat="server" ID="pnRegionCountry" Style="display: none;" ClientIDMode="Static" CssClass="row">
                    <div class="wd100 fl hg35 m0">
                      <%--  <li class="mR-2-p">--%>
                         <asp:TextBox ID="txtRegionCountry" ClientIDMode="Static" runat="server" placeholder="Add Region..." CssClass="row mB" />
