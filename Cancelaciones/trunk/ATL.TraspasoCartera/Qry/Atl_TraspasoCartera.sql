CREATE PROCEDURE [dbo].[ATL_TraspasoCartera]
...
SELECT  Poliza from p_polizaheader WHERE dbo.p_polizaheader.Intermediario = @IntermediarioOrigen   --and poliza ='05-175610-2010' 
ORDER BY dbo.p_polizaheader.Poliza 
