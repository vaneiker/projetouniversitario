...
namespace KSI.Cobranza.Web.Models.ViewModels
{
    public class PaymentProcessViewModels : BaseViewModels
    {
        ...
        [DependencyNumericValueValidator("share", "El campo Monto a cobrar no debe ser mayor a la cuota", DependencyNumericValueValidatorAttribute.LogicOperatorType.MenorOIgual, DependencyNumericValueValidatorAttribute.NumberType.Decimal)]
        ...
        public string receiptNumberEasybank { get; set; }
    }
}